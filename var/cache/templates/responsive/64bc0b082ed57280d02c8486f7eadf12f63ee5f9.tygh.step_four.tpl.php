<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 20:43:49
         compiled from "/var/www/html/design/themes/responsive/templates/views/checkout/components/steps/step_four.tpl" */ ?>
<?php /*%%SmartyHeaderCode:37058353655aa6d2da1a9b1-79723558%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '64bc0b082ed57280d02c8486f7eadf12f63ee5f9' => 
    array (
      0 => '/var/www/html/design/themes/responsive/templates/views/checkout/components/steps/step_four.tpl',
      1 => 1437201213,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '37058353655aa6d2da1a9b1-79723558',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa6d2dae7722_53076193',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa6d2dae7722_53076193')) {function content_55aa6d2dae7722_53076193($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/app/functions/smarty_plugins/function.script.php';
    ...
    <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['checkout_style']!="multi_page") {?>
        <h3 class="ty-step__title<?php if ($_smarty_tpl->tpl_vars['edit']->value) {?>-active<?php }?> clearfix">
            ...
            <?php if ($_smarty_tpl->tpl_vars['complete']->value&&!$_smarty_tpl->tpl_vars['edit']->value) {?>
                <a class="ty-step__title-txt cm-ajax" href="<?php echo htmlspecialchars(fn_url("checkout.checkout?edit_step=step_four&from_step=".((string)$_smarty_tpl->tpl_vars['edit_step']->value)), ENT_QUOTES, 'ISO-8859-1');?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['edit']->value) {?>
                    <div class="clearfix">
                        ...
                        <?php } else { ?>
                            ...
                            <form name="paymens_form" action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
" method="post">
