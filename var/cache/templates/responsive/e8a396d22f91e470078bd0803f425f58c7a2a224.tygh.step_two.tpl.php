...
<?php /*%%SmartyHeaderCode:176838212755aa6d2d773486-53920686%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '176838212755aa6d2d773486-53920686',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa6d2d90e8b7_94334650',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa6d2d90e8b7_94334650')) {function content_55aa6d2d90e8b7_94334650($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
...
<div class="ty-step__container<?php if ($_smarty_tpl->tpl_vars['edit']->value) {?>-active<?php }?> ty-step-two" data-ct-checkout="billing_shipping_address" id="step_two">
    <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['checkout_style']!="multi_page") {?>
        <h3 class="ty-step__title<?php if ($_smarty_tpl->tpl_vars['edit']->value) {?>-active<?php }?><?php if ($_smarty_tpl->tpl_vars['complete']->value&&!$_smarty_tpl->tpl_vars['edit']->value) {?>-complete<?php }?> clearfix">
            ...
            <?php if ($_smarty_tpl->tpl_vars['complete']->value&&!$_smarty_tpl->tpl_vars['edit']->value) {?>
                <a class="ty-step__title-txt cm-ajax" href="<?php echo htmlspecialchars(fn_url("checkout.checkout?edit_step=step_two&from_step=".((string)$_smarty_tpl->tpl_vars['edit_step']->value)), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id="checkout_*"><?php echo $_smarty_tpl->__("billing_shipping_address");?>
    ...
    <div id="step_two_body" class="ty-step__body<?php if ($_smarty_tpl->tpl_vars['edit']->value) {?>-active<?php }?><?php if (!$_smarty_tpl->tpl_vars['edit']->value) {?> hidden<?php }?> cm-skip-save-fields">
            <form name="step_two_billing_address" class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ajax_form']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" method="<?php if (!$_smarty_tpl->tpl_vars['edit']->value) {?>get<?php } else { ?>post<?php }?>">
            ...
            <input type="hidden" name="next_step" value="<?php if ($_REQUEST['from_step']&&$_REQUEST['from_step']!="step_two"&&$_REQUEST['from_step']!="step_one") {?><?php echo htmlspecialchars($_REQUEST['from_step'], ENT_QUOTES, 'ISO-8859-1');?>
