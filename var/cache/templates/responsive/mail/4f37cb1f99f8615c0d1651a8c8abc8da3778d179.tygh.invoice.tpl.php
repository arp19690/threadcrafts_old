...
<?php /*%%SmartyHeaderCode:5290849555aa6fcfc9a252-52316898%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '5290849555aa6fcfc9a252-52316898',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa6fd03affa6_74940811',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa6fd03affa6_74940811')) {function content_55aa6fd03affa6_74940811($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
...
<tr>
    ...
    <tr>
        <td style="background-color: #ffffff; border: 1px solid #e6e6e6; margin: 0px auto 0px auto; padding: 0px 44px 0px 46px; text-align: left;">
            ...
            <tr>
                <td align="left" style="padding-bottom: 3px;" valign="middle"><img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['logos']->value['mail']['image']['image_path'], ENT_QUOTES, 'ISO-8859-1');?>
" width="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['logos']->value['mail']['image']['image_x'], ENT_QUOTES, 'ISO-8859-1');?>
" height="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['logos']->value['mail']['image']['image_y'], ENT_QUOTES, 'ISO-8859-1');?>
" border="0" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['logos']->value['mail']['image']['alt'], ENT_QUOTES, 'ISO-8859-1');?>
" /></td>
                <td width="100%" valign="bottom" style="text-align: right;  font: bold 26px Arial; text-transform: uppercase;  margin: 0px;"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['order_header']->value)===null||$tmp==='' ? $_smarty_tpl->__("invoice_title") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</td>
            </tr>
            </table>
            ...
            <tr valign="top">
                ...
                <td style="width: 50%; padding: 14px 0px 0px 2px; font-size: 12px; font-family: Arial;">
                    <h2 style="font: bold 12px Arial; margin: 0px 0px 3px 0px;"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['company_name'], ENT_QUOTES, 'ISO-8859-1');?>
</h2>
                    <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['company_address'], ENT_QUOTES, 'ISO-8859-1');?>
<br />
                    <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['company_city'], ENT_QUOTES, 'ISO-8859-1');?>
<?php if ($_smarty_tpl->tpl_vars['company_data']->value['company_city']&&($_smarty_tpl->tpl_vars['company_data']->value['company_state_descr']||$_smarty_tpl->tpl_vars['company_data']->value['company_zipcode'])) {?>,<?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['company_state_descr'], ENT_QUOTES, 'ISO-8859-1');?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['company_zipcode'], ENT_QUOTES, 'ISO-8859-1');?>
<br />
                    <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['company_country_descr'], ENT_QUOTES, 'ISO-8859-1');?>
...
:</td>
                        <td width="100%" style="font-size: 12px; font-family: Arial;"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['company_phone'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
                    </tr>
                    <?php }?>
...
:</td>
                        <td width="100%" style="font-size: 12px; font-family: Arial;"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['company_phone_2'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
                    </tr>
                    <?php }?>
...
:</td>
                        <td width="100%" style="font-size: 12px; font-family: Arial;"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['company_fax'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
                    </tr>
                    <?php }?>
...
:</td>
                        <td width="100%" style="font-size: 12px; font-family: Arial;"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['company_website'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
                    </tr>
                    <?php }?>
...
:</td>
                        <td width="100%" style="font-size: 12px; font-family: Arial;"><a href="mailto:<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['company_orders_department'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars(smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->tpl_vars['company_data']->value['company_orders_department'],",","<br>")," ",''), ENT_QUOTES, 'ISO-8859-1');?>
</a></td>
                    </tr>
                    <?php }?>
                    </table>
                ...
                <td style="padding-top: 14px;">
                    <h2 style="font: bold 17px Tahoma; margin: 0px;"><?php if ($_smarty_tpl->tpl_vars['doc_id_text']->value) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['doc_id_text']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
:</td>
                        <td width="100%" style="font-size: 12px; font-family: Arial;"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_status']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
                    </tr>
                    <tr valign="top">
...
:</td>
                        <td style="font-size: 12px; font-family: Arial;"><?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['order_info']->value['timestamp'],((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['date_format']).", ".((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['time_format'])), ENT_QUOTES, 'ISO-8859-1');?>
</td>
                    </tr>
                    <tr valign="top">
...
:</td>
                        <td style="font-size: 12px; font-family: Arial;"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['payment_method']->value['payment'])===null||$tmp==='' ? " - " : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</td>
                    </tr>
...
:</h3>
                    <p style="margin: 2px 0px 3px 0px;"><?php if ($_smarty_tpl->tpl_vars['profields_c']->value['firstname']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['firstname'], ENT_QUOTES, 'ISO-8859-1');?>
&nbsp;<?php }?><?php if ($_smarty_tpl->tpl_vars['profields_c']->value['lastname']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['lastname'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?></p>
                    <?php if ($_smarty_tpl->tpl_vars['profields_c']->value['email']) {?><p style="margin: 2px 0px 3px 0px;"><a href="mailto:<?php echo htmlspecialchars(rawurlencode($_smarty_tpl->tpl_vars['order_info']->value['email']), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['email'], ENT_QUOTES, 'ISO-8859-1');?>
</a></p><?php }?>
...
:</span>&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['phone'], ENT_QUOTES, 'ISO-8859-1');?>
</p><?php }?>
...
:</span>&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['fax'], ENT_QUOTES, 'ISO-8859-1');?>
</p><?php }?>
...
:</span>&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['company'], ENT_QUOTES, 'ISO-8859-1');?>
</p><?php }?>
...
:</span>&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['url'], ENT_QUOTES, 'ISO-8859-1');?>
</p><?php }?>
...
:</h3>
                    ...
                    <p style="margin: 2px 0px 3px 0px;">
                        <?php if ($_smarty_tpl->tpl_vars['profields_b']->value['b_firstname']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['b_firstname'], ENT_QUOTES, 'ISO-8859-1');?>
 <?php }?><?php if ($_smarty_tpl->tpl_vars['profields_b']->value['b_lastname']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['b_lastname'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>
                    </p>
                    <?php }?>
                    ...
                    <p style="margin: 2px 0px 3px 0px;">
                        <?php if ($_smarty_tpl->tpl_vars['profields_b']->value['b_address']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['b_address'], ENT_QUOTES, 'ISO-8859-1');?>
 <?php }?><?php if ($_smarty_tpl->tpl_vars['profields_b']->value['b_address_2']) {?><br /><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['b_address_2'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>
                    </p>
                    <?php }?>
                    ...
                    <p style="margin: 2px 0px 3px 0px;">
                        <?php if ($_smarty_tpl->tpl_vars['profields_b']->value['b_city']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['b_city'], ENT_QUOTES, 'ISO-8859-1');?>
<?php if ($_smarty_tpl->tpl_vars['profields_b']->value['b_state']) {?>,<?php }?> <?php }?><?php if ($_smarty_tpl->tpl_vars['profields_b']->value['b_state']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['b_state_descr'], ENT_QUOTES, 'ISO-8859-1');?>
 <?php }?><?php if ($_smarty_tpl->tpl_vars['profields_b']->value['b_zipcode']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['b_zipcode'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>
                    </p>
                    <?php }?>
                    <?php if ($_smarty_tpl->tpl_vars['order_info']->value['b_country_descr']&&$_smarty_tpl->tpl_vars['profields_b']->value['b_country']) {?>
                    <p style="margin: 2px 0px 3px 0px;">
                        <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['b_country_descr'], ENT_QUOTES, 'ISO-8859-1');?>

                    </p>
                    <?php }?>
                    <?php if ($_smarty_tpl->tpl_vars['order_info']->value['b_phone']&&$_smarty_tpl->tpl_vars['profields_b']->value['b_phone']) {?>
                    <p style="margin: 2px 0px 3px 0px;">
                        <?php if ($_smarty_tpl->tpl_vars['profields_b']->value['b_phone']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['b_phone'], ENT_QUOTES, 'ISO-8859-1');?>
 <?php }?>
                    </p>
                    <?php }?>
...
:</h3>
                    ...
                    <p style="margin: 2px 0px 3px 0px;">
                        <?php if ($_smarty_tpl->tpl_vars['profields_s']->value['s_firstname']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['s_firstname'], ENT_QUOTES, 'ISO-8859-1');?>
 <?php }?><?php if ($_smarty_tpl->tpl_vars['profields_s']->value['s_lastname']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['s_lastname'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>
                    </p>
                    <?php }?>
                    ...
                    <p style="margin: 2px 0px 3px 0px;">
                        <?php if ($_smarty_tpl->tpl_vars['profields_s']->value['s_address']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['s_address'], ENT_QUOTES, 'ISO-8859-1');?>
 <?php }?><?php if ($_smarty_tpl->tpl_vars['profields_s']->value['s_address_2']) {?><br /><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['s_address_2'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>
                    </p>
                    <?php }?>
                    ...
                    <p style="margin: 2px 0px 3px 0px;">
                        <?php if ($_smarty_tpl->tpl_vars['profields_s']->value['s_city']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['s_city'], ENT_QUOTES, 'ISO-8859-1');?>
<?php if ($_smarty_tpl->tpl_vars['profields_s']->value['s_state']) {?>,<?php }?> <?php }?><?php if ($_smarty_tpl->tpl_vars['profields_s']->value['s_state']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['s_state_descr'], ENT_QUOTES, 'ISO-8859-1');?>
 <?php }?><?php if ($_smarty_tpl->tpl_vars['profields_s']->value['s_zipcode']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['s_zipcode'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>
                    </p>
                    <?php }?>
                    <?php if ($_smarty_tpl->tpl_vars['order_info']->value['s_country_descr']&&$_smarty_tpl->tpl_vars['profields_s']->value['s_country']) {?>
                    <p style="margin: 2px 0px 3px 0px;">
                        <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['s_country_descr'], ENT_QUOTES, 'ISO-8859-1');?>

                    </p>
                    <?php }?>
                    <?php if ($_smarty_tpl->tpl_vars['order_info']->value['s_phone']&&$_smarty_tpl->tpl_vars['profields_s']->value['s_phone']) {?>
                    <p style="margin: 2px 0px 3px 0px;">
                        <?php if ($_smarty_tpl->tpl_vars['profields_s']->value['s_phone']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_info']->value['s_phone'], ENT_QUOTES, 'ISO-8859-1');?>
 <?php }?>
                    </p>
                    <?php }?>
...
<?php }?>
                    ...
                    <td style="padding: 5px 10px; background-color: #ffffff; text-align: center; font-size: 12px; font-family: Arial;"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['oi']->value['amount'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
...
:</b>&nbsp;</td>
                    <td style="text-align: right; white-space: nowrap; font-size: 12px; font-family: Arial;"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'ISO-8859-1');?>
</td>
                </tr>
                <?php } ?>
                <?php }?>
...
?>
                <tr>
                    <td style="text-align: right; white-space: nowrap; font-size: 12px; font-family: Arial;"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tax_data']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
...
<?php }?><?php if ($_smarty_tpl->tpl_vars['tax_data']->value['regnumber']) {?>&nbsp;(<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tax_data']->value['regnumber'], ENT_QUOTES, 'ISO-8859-1');?>
)<?php }?>:&nbsp;</td>
                ...
                <tr>
                    <td style="text-align: right; white-space: nowrap; font-size: 12px; font-family: Arial;"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['order_info']->value['payment_method']['surcharge_title'])===null||$tmp==='' ? $_smarty_tpl->__("payment_surcharge") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
:&nbsp;</td>
