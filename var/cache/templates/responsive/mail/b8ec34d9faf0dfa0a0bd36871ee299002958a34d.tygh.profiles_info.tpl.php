<?php /* Smarty version Smarty-3.1.18, created on 2015-08-07 15:06:11
         compiled from "/var/www/html/design/themes/responsive/mail/templates/profiles/profiles_info.tpl" */ ?>
<?php /*%%SmartyHeaderCode:67879203855c47c0b54d9f1-98268254%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b8ec34d9faf0dfa0a0bd36871ee299002958a34d' => 
    array (
      0 => '/var/www/html/design/themes/responsive/mail/templates/profiles/profiles_info.tpl',
      1 => 1437201213,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '67879203855c47c0b54d9f1-98268254',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55c47c0b69d633_33618658',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55c47c0b69d633_33618658')) {function content_55c47c0b69d633_33618658($_smarty_tpl) {?><?php if (!is_callable('smarty_function_split')) include '/var/www/html/app/functions/smarty_plugins/function.split.php';
if (!is_callable('smarty_function_set_id')) include '/var/www/html/app/functions/smarty_plugins/function.set_id.php';
?><?php
fn_preload_lang_vars(array('user_account_info','username','email','password','login','url','usergroups','pending','active','profile_name','tax_exempt','yes','contact_information','contact_information','billing_address','shipping_address','user_account_info','username','email','password','login','url','usergroups','pending','active','profile_name','tax_exempt','yes','contact_information','contact_information','billing_address','shipping_address'));
?>
...
:&nbsp;</td>
                <td><?php if ($_smarty_tpl->tpl_vars['user_data']->value['company_id']) {?><?php echo htmlspecialchars(fn_url("?company_id=".((string)$_smarty_tpl->tpl_vars['user_data']->value['company_id']),'C','http'), ENT_QUOTES, 'UTF-8');?>
<?php } else { ?><?php echo htmlspecialchars(fn_url('','C','http'), ENT_QUOTES, 'UTF-8');?>
<?php }?></td>
            </tr>
        <?php }?>
