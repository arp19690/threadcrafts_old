<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 12:29:59
         compiled from "/var/www/html/design/backend/templates/common/saved_search.tpl" */ ?>
<?php /*%%SmartyHeaderCode:110450585055a9f96f7940c8-06089474%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8a1ad7676146f0a8b67e6b3062092d150b392952' => 
    array (
  ...
  'nocache_hash' => '110450585055a9f96f7940c8-06089474',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9f96f8156b2_71396596',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9f96f8156b2_71396596')) {function content_55a9f96f8156b2_71396596($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
?><?php
            ...
            <h6><?php echo $_smarty_tpl->__("saved_search");?>
                ...
                <ul class="nav nav-list saved-search">
                    ...
                    <li <?php if (!$_smarty_tpl->tpl_vars['search']->value['view_id']) {?>class="active"<?php }?>>
                        <a href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['dispatch']->value).".reset_view"), ENT_QUOTES, 'ISO-8859-1');?>
...
" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['dispatch']->value)."?view_id=".((string)$_smarty_tpl->tpl_vars['view']->value['view_id'])), ENT_QUOTES, 'ISO-8859-1');?>
