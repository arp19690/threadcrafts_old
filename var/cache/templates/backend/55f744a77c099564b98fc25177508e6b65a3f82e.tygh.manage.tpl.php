...
<?php /*%%SmartyHeaderCode:76530282355a9f9de656e53-23468359%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '76530282355a9f9de656e53-23468359',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9f9de794902_57927890',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9f9de794902_57927890')) {function content_55a9f9de794902_57927890($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/app/functions/smarty_plugins/function.script.php';
...
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                    <li class="with-menu <?php if ($_smarty_tpl->tpl_vars['layout']->value['layout_id']==$_smarty_tpl->tpl_vars['runtime']->value['layout']['layout_id']) {?> active<?php }?>">
                        <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
                            <li><?php ob_start();?><?php echo htmlspecialchars(fn_url("?s_layout=".((string)$_smarty_tpl->tpl_vars['layout']->value['layout_id']),"C"), ENT_QUOTES, 'ISO-8859-1');?>
...
cw.src = '//widget.cart-services.com/static/init.js?url=' + url + '&layout=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['runtime']->value['layout']['layout_id'], ENT_QUOTES, 'ISO-8859-1');?>
';
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
            ...
            <div class="clearfix">
                <fieldset>
                    <textarea class="copy-field" id="widget_code_box" readonly="readonly" cols="30" rows="10"><?php echo htmlspecialchars(Smarty::$_smarty_vars['capture']['widget_code'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
