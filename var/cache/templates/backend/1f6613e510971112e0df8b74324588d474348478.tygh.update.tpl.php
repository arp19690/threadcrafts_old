<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 15:31:51
         compiled from "/var/www/html/design/backend/templates/views/shippings/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:168121095855aa240fad49c2-55327018%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1f6613e510971112e0df8b74324588d474348478' => 
    array (
      0 => '/var/www/html/design/backend/templates/views/shippings/update.tpl',
      1 => 1437201145,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '168121095855aa240fad49c2-55327018',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa240fc52e70_15652205',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa240fc52e70_15652205')) {function content_55aa240fc52e70_15652205($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_in_array')) include '/var/www/html/app/functions/smarty_plugins/modifier.in_array.php';
...
(function(_, $) {
    $(document).ready(function() {
        ...
        $('#elm_service').on('change', function() {
            ...
            if (option.val()) {
                href = fn_url('shippings.configure?shipping_id=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" class="input-mini" />&nbsp;-&nbsp;<input type="text" name="shipping_data[max_weight]" size="4" value="<?php if ($_smarty_tpl->tpl_vars['shipping']->value['max_weight']!="0.00") {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['max_weight'], ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                <option data-ca-shipping-module="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['service']->value['module'], ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-shipping-code="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['service']->value['code'], ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['service']->value['service_id'], ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['shipping']->value['service_id']==$_smarty_tpl->tpl_vars['service']->value['service_id']) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['service']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
            <?php } ?>
        </select>
        <?php if ($_smarty_tpl->tpl_vars['allow_save']->value) {?>
