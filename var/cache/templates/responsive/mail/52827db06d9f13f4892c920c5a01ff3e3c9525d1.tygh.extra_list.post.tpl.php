<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 20:55:04
         compiled from "/var/www/html/design/themes/responsive/mail/templates/addons/gift_certificates/hooks/orders/extra_list.post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:157203962355aa6fd06b4447-10554090%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '52827db06d9f13f4892c920c5a01ff3e3c9525d1' => 
    array (
      0 => '/var/www/html/design/themes/responsive/mail/templates/addons/gift_certificates/hooks/orders/extra_list.post.tpl',
      1 => 1437201219,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '157203962355aa6fd06b4447-10554090',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa6fd0838725_12331629',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa6fd0838725_12331629')) {function content_55aa6fd0838725_12331629($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
...
<tr>
    ...
    <td style="padding: 5px 10px; background-color: #ffffff; font-size: 12px; font-family: Arial;" colspan="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_colspan']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
        <p><?php echo $_smarty_tpl->__("free_products");?>
 (<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['gift']->value['gift_cert_code'])===null||$tmp==='' ? "&nbsp;" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
):</p>
...
?>
        ...
        <tr>
            <td style="padding: 5px 10px; background-color: #ffffff; font-size: 12px; font-family: Arial;"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['oi']->value['product'])===null||$tmp==='' ? $_smarty_tpl->__("deleted_product") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
