<?php /* Smarty version Smarty-3.1.18, created on 2015-09-02 11:18:54
         compiled from "/var/www/html/design/themes/responsive/templates/views/orders/details.tpl" */ ?>
<?php /*%%SmartyHeaderCode:51107154555e68dc6586790-64553346%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f15ac650dbaa221f76f38d07b653c4a9356e32bc' => 
    array (
      0 => '/var/www/html/design/themes/responsive/templates/views/orders/details.tpl',
      1 => 1439189910,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '51107154555e68dc6586790-64553346',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55e68dc6af5c04_56481305',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55e68dc6af5c04_56481305')) {function content_55e68dc6af5c04_56481305($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
...
?><?php
fn_preload_lang_vars(array('print_invoice','print_pdf_invoice','print_credit_memo','print_pdf_credit_memo','print_order_details','print_pdf_order_details','re_order','products_information','product','price','quantity','discount','tax','subtotal','download','sku','free','free','customer_notes','summary','payment_method','shipping_method','tracking_num','subtotal','shipping_cost','including_discount','order_discount','coupon','taxes','included','tax_exempt','payment_surcharge','total','shipment','product','quantity','download','sku','shipping_information','carrier','tracking_num','comments','text_no_shipments_found','order','status','print_invoice','print_pdf_invoice','print_credit_memo','print_pdf_credit_memo','print_order_details','print_pdf_order_details','re_order','products_information','product','price','quantity','discount','tax','subtotal','download','sku','free','free','customer_notes','summary','payment_method','shipping_method','tracking_num','subtotal','shipping_cost','including_discount','order_discount','coupon','taxes','included','tax_exempt','payment_surcharge','total','shipment','product','quantity','download','sku','shipping_information','carrier','tracking_num','comments','text_no_shipments_found','order','status'));
?>
...
&nbsp;(<?php echo $_smarty_tpl->__("tracking_num");?>
...
<?php if ($_smarty_tpl->tpl_vars['shipment']->value['tracking_number']) {?>(<?php echo $_smarty_tpl->__("tracking_num");?>
