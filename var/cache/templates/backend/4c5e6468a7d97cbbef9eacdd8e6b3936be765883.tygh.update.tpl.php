<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 15:29:34
         compiled from "/var/www/html/design/backend/templates/views/companies/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7625058355aa23869c66e9-43826167%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4c5e6468a7d97cbbef9eacdd8e6b3936be765883' => 
    array (
  ...
  'nocache_hash' => '7625058355aa23869c66e9-43826167',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa2386d13439_46093129',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa2386d13439_46093129')) {function content_55aa2386d13439_46093129($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
...
?>
            <div class="control-group">
                ...
                <label class="control-label" for="elm_company_clone_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['object']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
<?php }?>:</label>
                <div class="controls">
                    <label class="checkbox"><input type="checkbox" name="company_data[clone][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['object']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" id="elm_company_clone_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['object']->value, ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['object_data']->value['checked_by_default']) {?>checked="checked"<?php }?> class="cm-dependence-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['object']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
', this.checked)" onclick="fn_check_dependence('<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['object_data']->value['dependence'], ENT_QUOTES, 'ISO-8859-1');?>
...
:</label>
    ...
    <?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_id']) {?>
        http://<?php echo htmlspecialchars(smarty_modifier_unpuny($_smarty_tpl->tpl_vars['company_data']->value['storefront']), ENT_QUOTES, 'ISO-8859-1');?>

    <?php } else { ?>
        <input type="text" name="company_data[storefront]" id="elm_company_storefront" size="32" value="<?php echo htmlspecialchars(smarty_modifier_unpuny($_smarty_tpl->tpl_vars['company_data']->value['storefront']), ENT_QUOTES, 'ISO-8859-1');?>
...
:</label>
    <div class="controls">
    <?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_id']) {?>
        https://<?php echo htmlspecialchars(smarty_modifier_unpuny($_smarty_tpl->tpl_vars['company_data']->value['secure_storefront']), ENT_QUOTES, 'ISO-8859-1');?>

    <?php } else { ?>
        <input type="text" name="company_data[secure_storefront]" id="elm_company_secure_storefront" size="32" value="<?php echo htmlspecialchars(smarty_modifier_unpuny($_smarty_tpl->tpl_vars['company_data']->value['secure_storefront']), ENT_QUOTES, 'ISO-8859-1');?>
...
:</label>
            <div class="controls">
                <input type="text" name="company_data[admin_username]" id="elm_company_vendor_username" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['admin_username'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-large" />
            </div>
        </div>
        <div class="control-group">
...
:</label>
            <div class="controls">
                <input type="text" name="company_data[admin_firstname]" id="elm_company_vendor_firstname" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['admin_first_name'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-large" />
            </div>
        </div>
        <div class="control-group">
...
:</label>
            <div class="controls">
                <input type="text" name="company_data[admin_lastname]" id="elm_company_vendor_lastname" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['admin_last_name'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-large" />
            </div>
        </div>
    <?php }?>
...
:</label>
    <div class="controls">
    <input type="text" name="company_data[commission]" id="elm_company_vendor_commission" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['commission'], ENT_QUOTES, 'ISO-8859-1');?>
"  />
...
:</label>
    <div class="controls">
        <input type="text" name="company_data[request_account_name]" id="elm_company_request_account_name" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['request_account_name'], ENT_QUOTES, 'ISO-8859-1');?>
" />
    </div>
</div>
<?php }?>
...
:</label>
    <div class="controls">
        <input type="text" name="company_data[email]" id="elm_company_email" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['email'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-large" />
    </div>
</div>
...
:</label>
    <div class="controls">
        <input type="text" class="input-large" name="company_data[phone]" id="elm_company_phone" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['phone'], ENT_QUOTES, 'ISO-8859-1');?>
" />
    </div>
</div>
...
:</label>
    <div class="controls">
        <input type="text" class="input-large" name="company_data[url]" id="elm_company_url" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['url'], ENT_QUOTES, 'ISO-8859-1');?>
" />
    </div>
</div>
...
:</label>
    <div class="controls">
        <input type="text" class="input-large" name="company_data[fax]" id="elm_company_fax" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['fax'], ENT_QUOTES, 'ISO-8859-1');?>
"  />
    </div>
</div>
...
:</label>
    <div class="controls">
        <input type="text" class="input-large" name="company_data[address]" id="elm_company_address" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['address'], ENT_QUOTES, 'ISO-8859-1');?>
" />
    </div>
</div>
...
:</label>
    <div class="controls">
        <input type="text" class="input-large" name="company_data[city]" id="elm_company_city" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['city'], ENT_QUOTES, 'ISO-8859-1');?>
" />
    </div>
</div>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['state']->value['state'], ENT_QUOTES, 'ISO-8859-1');?>
    ...
    <input type="text" id="elm_company_state_d" name="company_data[state]" size="32" maxlength="64" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_state']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
:</label>
    <div class="controls">
        <input type="text" name="company_data[zipcode]" id="elm_company_zipcode" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['zipcode'], ENT_QUOTES, 'ISO-8859-1');?>
" />
    </div>
</div>
...
?>
        <tr>
            <td><a href="<?php echo htmlspecialchars(fn_url("shippings.update?shipping_id=".((string)$_smarty_tpl->tpl_vars['shipping_id']->value)), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['shipping'], ENT_QUOTES, 'ISO-8859-1');?>
<?php if ($_smarty_tpl->tpl_vars['shipping']->value['status']=="D") {?> (<?php echo strtolower($_smarty_tpl->__("disabled"));?>
)<?php }?></a></td>
            <td class="center">
