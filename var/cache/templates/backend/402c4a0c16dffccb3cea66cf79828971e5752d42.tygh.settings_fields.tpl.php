<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 09:45:15
         compiled from "/var/www/html/design/backend/templates/common/settings_fields.tpl" */ ?>
<?php /*%%SmartyHeaderCode:26952714755a9f5fbc86ea8-68194078%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '402c4a0c16dffccb3cea66cf79828971e5752d42' => 
    array (
  ...
  'nocache_hash' => '26952714755a9f5fbc86ea8-68194078',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9f5fbe343c3_91640096',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9f5fbe343c3_91640096')) {function content_55a9f5fbe343c3_91640096($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_in_array')) include '/var/www/html/app/functions/smarty_plugins/modifier.in_array.php';
?><?php
...
<?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['section_name'], ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['item']->value['value'][$_smarty_tpl->tpl_vars['k']->value]=="Y") {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['v']->value, ENT_QUOTES, 'ISO-8859-1');?>
</option>
                <?php } ?>
                </select>
...
" type="button" class="btn" onclick="Tygh.fileuploader.init('box_server_upload', this.id);" <?php if ($_smarty_tpl->tpl_vars['disable_input']->value) {?>disabled="disabled"<?php }?>><?php echo $_smarty_tpl->__("browse");?>
            ...
            <?php } elseif ($_smarty_tpl->tpl_vars['item']->value['type']=="G") {?>
                <div id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                    <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
 $_smarty_tpl->tpl_vars["k"] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['item']->value['variants']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
