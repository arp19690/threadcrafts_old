<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 09:42:51
         compiled from "/var/www/html/design/backend/mail/templates/profiles/profiles_info.tpl" */ ?>
<?php /*%%SmartyHeaderCode:182810822955a9f56b765529-32348448%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '04a3dcdf9b975ac8e0a7d6a027d6177cecbd7d5a' => 
    array (
      0 => '/var/www/html/design/backend/mail/templates/profiles/profiles_info.tpl',
      1 => 1437201145,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '182810822955a9f56b765529-32348448',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9f56b807c27_08714789',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9f56b807c27_08714789')) {function content_55a9f56b807c27_08714789($_smarty_tpl) {?><?php if (!is_callable('smarty_function_split')) include '/var/www/html/app/functions/smarty_plugins/function.split.php';
?><?php
...
:&nbsp;</td>
            <td ><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['user_login'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
        </tr>
        <?php } else { ?>
        <tr>
...
:&nbsp;</td>
                <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['password']->value, ENT_QUOTES, 'ISO-8859-1');?>
</td>
            </tr>
            <?php }?>
            <tr>
...
:&nbsp;</td>
                ...
                <?php }?>
                <td><?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['login_url']->value,$_smarty_tpl->tpl_vars['user_data']->value['user_type']), ENT_QUOTES, 'ISO-8859-1');?>
</td>
            </tr>
        <?php }?>
...
?>
                    <tr>
                        <td class="form-field-caption" nowrap><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_usergroup']->value['usergroup'], ENT_QUOTES, 'ISO-8859-1');?>
:&nbsp;</td>
...
:&nbsp;</td>
            <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['profile_name'], ENT_QUOTES, 'ISO-8859-1');?>
</td>
        </tr>
        <?php }?>
