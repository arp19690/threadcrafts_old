...
<?php /*%%SmartyHeaderCode:8059060455a9f3937d3b38-39436892%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '8059060455a9f3937d3b38-39436892',
  'function' => 
  array (
    'get_orders' => 
    array (
  ...
  'unifunc' => 'content_55a9f393a52a30_13863942',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9f393a52a30_13863942')) {function content_55a9f393a52a30_13863942($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
...
"><?php echo htmlspecialchars(count($_smarty_tpl->tpl_vars['orders_stat']->value['orders']), ENT_QUOTES, 'ISO-8859-1');?>
                                ...
                                <?php echo htmlspecialchars(count($_smarty_tpl->tpl_vars['orders_stat']->value['prev_orders']), ENT_QUOTES, 'ISO-8859-1');?>
, <?php if ($_smarty_tpl->tpl_vars['orders_stat']->value['diff']['orders_count']>0) {?>+<?php }?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['orders_stat']->value['diff']['orders_count'], ENT_QUOTES, 'ISO-8859-1');?>
...
"><?php echo $_smarty_tpl->__("order");?>
 #<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value['order_id'], ENT_QUOTES, 'ISO-8859-1');?>
...
"><?php }?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value['lastname'], ENT_QUOTES, 'ISO-8859-1');?>
...
"><?php echo htmlspecialchars(number_format($_smarty_tpl->tpl_vars['general_stats']->value['products']['total_products']), ENT_QUOTES, 'ISO-8859-1');?>
                            ...
                            <td>
                                <div class="dashboard-card">
                                    ...
                                    <div class="dashboard-card-content">
                                        <h3><a href="<?php ob_start();?><?php echo htmlspecialchars(smarty_modifier_enum("ProductTracking::TRACK_WITHOUT_OPTIONS"), ENT_QUOTES, 'ISO-8859-1');?>
<?php $_tmp1=ob_get_clean();?><?php ob_start();?><?php echo htmlspecialchars(smarty_modifier_enum("ProductTracking::TRACK_WITH_OPTIONS"), ENT_QUOTES, 'ISO-8859-1');?>
<?php $_tmp2=ob_get_clean();?><?php echo htmlspecialchars(fn_url("products.manage?amount_from=&amount_to=0&tracking[0]=".$_tmp1."&tracking[1]=".$_tmp2), ENT_QUOTES, 'ISO-8859-1');?>
...
"><?php }?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['content']['user'], ENT_QUOTES, 'ISO-8859-1');?>
...
" id="after_install_dialog" data-ca-dialog-class="welcome-screen-dialog">
        ...
        <?php if (fn_allowed_for("ULTIMATE")) {?>
            <?php ob_start();?><?php echo htmlspecialchars(smarty_modifier_unpuny($_smarty_tpl->tpl_vars['company']->value['storefront']), ENT_QUOTES, 'ISO-8859-1');?>
<?php $_tmp3=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['link_storefront'] = new Smarty_variable("http://".$_tmp3, null, 0);?>
        <?php } else { ?>
            <?php ob_start();?><?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['config']->value['http_location']), ENT_QUOTES, 'ISO-8859-1');?>
