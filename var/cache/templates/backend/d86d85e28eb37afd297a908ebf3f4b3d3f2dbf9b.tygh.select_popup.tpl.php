<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 09:42:59
         compiled from "/var/www/html/design/backend/templates/common/select_popup.tpl" */ ?>
<?php /*%%SmartyHeaderCode:67327196755a9f5735d1480-69388082%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd86d85e28eb37afd297a908ebf3f4b3d3f2dbf9b' => 
    array (
  ...
  'nocache_hash' => '67327196755a9f5735d1480-69388082',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9f573700e75_82848404',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9f573700e75_82848404')) {function content_55a9f573700e75_82848404($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
...
<div class="cm-popup-box dropleft <?php if (!$_smarty_tpl->tpl_vars['hide_for_vendor']->value) {?>dropdown<?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['popup_additional_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
    <?php if (!$_smarty_tpl->tpl_vars['hide_for_vendor']->value) {?>
        <a <?php if ($_smarty_tpl->tpl_vars['id']->value) {?>id="sw_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_wrap"<?php }?> class="<?php if ($_smarty_tpl->tpl_vars['btn_meta']->value) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btn_meta']->value, ENT_QUOTES, 'ISO-8859-1');?>
<?php }?> btn dropdown-toggle<?php if ($_smarty_tpl->tpl_vars['id']->value) {?> cm-combination<?php }?>" data-toggle="dropdown">
    ...
    <?php if ($_smarty_tpl->tpl_vars['id']->value&&!$_smarty_tpl->tpl_vars['hide_for_vendor']->value) {?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['table']->value&&$_smarty_tpl->tpl_vars['object_id_name']->value) {?><?php $_smarty_tpl->_capture_stack[0][] = array("_extra", null, null); ob_start(); ?>&table=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['table']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
?>
 ...
 <?php if ($_smarty_tpl->tpl_vars['status']->value==$_smarty_tpl->tpl_vars['st']->value) {?>active<?php } else { ?>cm-ajax<?php }?> <?php if ($_smarty_tpl->tpl_vars['status_meta']->value) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['status_meta']->value, ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>"<?php if ($_smarty_tpl->tpl_vars['status_target_id']->value) {?> data-ca-target-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['status_target_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
', '<?php if ($_smarty_tpl->tpl_vars['statuses']->value) {?><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['statuses']->value[$_smarty_tpl->tpl_vars['st']->value]['params']['color'])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>');" <?php if ($_smarty_tpl->tpl_vars['st_result_ids']->value) {?>data-ca-target-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['st_result_ids']->value, ENT_QUOTES, 'ISO-8859-1');?>
