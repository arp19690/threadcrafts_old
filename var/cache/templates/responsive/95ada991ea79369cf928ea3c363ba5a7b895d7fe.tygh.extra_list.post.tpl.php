<?php /* Smarty version Smarty-3.1.18, created on 2015-07-24 10:24:49
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/work/svn/threadcrafts/design/themes/responsive/templates/addons/gift_certificates/hooks/checkout/extra_list.post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:63500877855b1c519b47289-43699129%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '95ada991ea79369cf928ea3c363ba5a7b895d7fe' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/work/svn/threadcrafts/design/themes/responsive/templates/addons/gift_certificates/hooks/checkout/extra_list.post.tpl',
      1 => 1437239221,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '63500877855b1c519b47289-43699129',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55b1c519dcdb79_49063718',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55b1c519dcdb79_49063718')) {function content_55b1c519dcdb79_49063718($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Applications/XAMPP/xamppfiles/htdocs/work/svn/threadcrafts/app/functions/smarty_plugins/modifier.truncate.php';
if (!is_callable('smarty_block_hook')) include '/Applications/XAMPP/xamppfiles/htdocs/work/svn/threadcrafts/app/functions/smarty_plugins/block.hook.php';
...
" class="ty-cart-content__product-title">
 ...
 ty-delete-big" href="<?php echo htmlspecialchars(fn_url("gift_certificates.delete?gift_cert_id=".((string)$_smarty_tpl->tpl_vars['gift_key']->value)."&redirect_url=".((string)$_smarty_tpl->tpl_vars['c_url']->value)), ENT_QUOTES, 'UTF-8');?>
...
:</label><span class="ty-control-group__item"><?php if ($_smarty_tpl->tpl_vars['gift']->value['send_via']=="E") {?><?php echo $_smarty_tpl->__("email");?>
...
:&nbsp;</strong>
                <?php if (!$_smarty_tpl->tpl_vars['gift']->value['extra']['exclude_from_calculate']) {?><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['gift']->value['display_subtotal'],'class'=>"ty-price"), 0);?>
<?php } else { ?><span class="ty-price"><?php echo $_smarty_tpl->__("free");?>
</span><?php }?>
            </div>
...
">
        <?php if (!$_smarty_tpl->tpl_vars['gift']->value['extra']['exclude_from_calculate']) {?><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['gift']->value['display_subtotal'],'class'=>"ty-sub-price"), 0);?>
<?php } else { ?><span class="ty-price"><?php echo $_smarty_tpl->__("free");?>
</span><?php }?>
