<?php /* Smarty version Smarty-3.1.18, created on 2015-07-20 12:52:14
         compiled from "/var/www/html/design/backend/templates/addons/gift_certificates/hooks/orders/extra_list.post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:110230029955aca1a6e24b79-40455482%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6b66c21e069633ca68a881b8f0154e9bed6edb47' => 
    array (
      0 => '/var/www/html/design/backend/templates/addons/gift_certificates/hooks/orders/extra_list.post.tpl',
      1 => 1437201145,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '110230029955aca1a6e24b79-40455482',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aca1a6f21ec7_22703576',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aca1a6f21ec7_22703576')) {function content_55aca1a6f21ec7_22703576($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/html/app/functions/smarty_plugins/modifier.truncate.php';
...
" class="hand cm-combination exicon-expand"></i><i title="<?php echo $_smarty_tpl->__("collapse_sublist_of_items");?>
...
<?php }?></td>
    ...
    <td>-</td>
    <?php }?>
    <td class="right">&nbsp;<span><?php if (!$_smarty_tpl->tpl_vars['gift']->value['extra']['exclude_from_calculate']) {?><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['gift']->value['display_subtotal']), 0);?>
<?php } else { ?><?php echo $_smarty_tpl->__("free");?>
<?php }?></span></td>
</tr>
...
">
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td class="nowrap" width="100%"><?php if ($_smarty_tpl->tpl_vars['gift']->value['send_via']=="E") {?><?php echo $_smarty_tpl->__("email");?>
...
"><?php }?><?php echo htmlspecialchars(smarty_modifier_truncate($_smarty_tpl->tpl_vars['oi']->value['product'],50,"...",true), ENT_QUOTES, 'UTF-8');?>
