<?php /* Smarty version Smarty-3.1.18, created on 2015-08-11 09:54:26
         compiled from "/var/www/html/design/backend/templates/pickers/companies/js.tpl" */ ?>
<?php /*%%SmartyHeaderCode:189425410855c978fa990375-06487882%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '42ddd70e8ed557910acc17814589f90ae1fd3426' => 
    array (
      0 => '/var/www/html/design/backend/templates/pickers/companies/js.tpl',
      1 => 1439189760,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '189425410855c978fa990375-06487882',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55c978faa0a7f8_34027557',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55c978faa0a7f8_34027557')) {function content_55c978faa0a7f8_34027557($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/app/lib/other/smarty/plugins/function.math.php';
?><?php
...
" size="3" class="input-text-short"<?php if ($_smarty_tpl->tpl_vars['clone']->value) {?> disabled="disabled"<?php }?> /><?php }?><?php if (!$_smarty_tpl->tpl_vars['view_only']->value) {?><a href="<?php echo htmlspecialchars(fn_url("companies.update?company_id=".((string)$_smarty_tpl->tpl_vars['company_id']->value)), ENT_QUOTES, 'UTF-8');?>
"><?php }?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company']->value, ENT_QUOTES, 'UTF-8');?>
<?php if (!$_smarty_tpl->tpl_vars['view_only']->value) {?></a><?php }?></td>
        <td class="nowrap">
        <?php if (!$_smarty_tpl->tpl_vars['hide_delete_button']->value&&!$_smarty_tpl->tpl_vars['view_only']->value) {?>
            <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
                <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("remove"),'onclick'=>"Tygh."."$".".cePicker('delete_js_item', '".((string)$_smarty_tpl->tpl_vars['holder']->value)."', '".((string)$_smarty_tpl->tpl_vars['company_id']->value)."', 'm'); return false;"));?>
</li>
                <?php if (!$_smarty_tpl->tpl_vars['hide_edit_button']->value!="view") {?>
                    <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("edit"),'href'=>"companies.update?company_id=".((string)$_smarty_tpl->tpl_vars['company_id']->value)));?>
</li>
                <?php }?>
