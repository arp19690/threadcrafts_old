<?php /* Smarty version Smarty-3.1.18, created on 2015-08-12 13:15:16
         compiled from "/var/www/html/design/themes/responsive/templates/common/ajax_select_object.tpl" */ ?>
<?php /*%%SmartyHeaderCode:164888394255caf98ceebca2-52227688%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '164888394255caf98ceebca2-52227688',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55caf98d012bc2_62252057',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55caf98d012bc2_62252057')) {function content_55caf98d012bc2_62252057($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/html/app/functions/smarty_plugins/function.set_id.php';
?><?php
...
<?php if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['design']=="Y"&&@constant('AREA')=="C") {?><?php $_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start(); ?><div class="select-vendor">
    <?php if ($_smarty_tpl->tpl_vars['label']->value) {?>
        <label class="ty-control-group__title select-vendor__title"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['label']->value, ENT_QUOTES, 'UTF-8');?>
</label>
    <?php }?>

    <a class="ty-select-block__a">
        <span id="sw_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_wrap_" class="ty-select-block__a-item cm-combination"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['text']->value, ENT_QUOTES, 'UTF-8');?>
</span>
...
..." class="ty-select-block__input cm-hint cm-ajax-content-input" data-ca-target-id="content_loader_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
" size="16" />
        <div id="scroller_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
">
            <ul class="cm-select-list ty-select-block__list" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
">
...
?>
                    <li><a class="ty-select-block__list-a" data-ca-action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['value'], ENT_QUOTES, 'UTF-8');?>
