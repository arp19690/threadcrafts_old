...
<?php /*%%SmartyHeaderCode:96643080355a9f37da143f9-06118450%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '96643080355a9f37da143f9-06118450',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9f37dbbc7e5_37630822',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9f37dbbc7e5_37630822')) {function content_55a9f37dbbc7e5_37630822($_smarty_tpl) {?><?php if (!is_callable('smarty_function_live_edit')) include '/var/www/html/app/functions/smarty_plugins/function.live_edit.php';
...
">
 ...
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_info']->value['lastname'], ENT_QUOTES, 'ISO-8859-1');?>
                ...
                <?php } else { ?>
                    ...
                    <?php } else { ?>
                        <li class="ty-account-info__item ty-dropdown-box__item ty-account-info__name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_info']->value['user_login'], ENT_QUOTES, 'ISO-8859-1');?>
</li>
                    <?php }?>
                <?php }?>
...
" rel="nofollow"><?php echo $_smarty_tpl->__("downloads");?>
 ...
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['lastname'], ENT_QUOTES, 'ISO-8859-1');?>
            ...
            <?php } elseif ($_smarty_tpl->tpl_vars['settings']->value['General']['use_email_as_login']!='Y'&&$_smarty_tpl->tpl_vars['user_data']->value['user_login']) {?>
                <li class="ty-account-info__item ty-dropdown-box__item ty-account-info__name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['user_login'], ENT_QUOTES, 'ISO-8859-1');?>
</li>
            <?php }?>
...
<?php if ($_smarty_tpl->tpl_vars['compared_products']->value) {?> (<?php echo htmlspecialchars(count($_smarty_tpl->tpl_vars['compared_products']->value), ENT_QUOTES, 'ISO-8859-1');?>
)<?php }?></a></li>
        ...
        <?php if (fn_allowed_for("MULTIVENDOR")&&$_smarty_tpl->tpl_vars['settings']->value['Vendors']['apply_for_vendor']=="Y"&&!$_smarty_tpl->tpl_vars['user_info']->value['company_id']) {?>
            <li class="ty-account-info__item ty-dropdown-box__item"><a class="ty-account-info__a underlined" href="<?php echo htmlspecialchars(fn_url("companies.apply_for_vendor?return_previous_url=".((string)$_smarty_tpl->tpl_vars['return_current_url']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
" rel="nofollow" class="ty-btn ty-btn__primary"><?php echo $_smarty_tpl->__("sign_out");?>
        ...
        <?php } else { ?>
            <a href="<?php if ($_smarty_tpl->tpl_vars['runtime']->value['controller']=="auth"&&$_smarty_tpl->tpl_vars['runtime']->value['mode']=="login_form") {?><?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'ISO-8859-1');?>
<?php } else { ?><?php echo htmlspecialchars(fn_url("auth.login_form?return_url=".((string)$_smarty_tpl->tpl_vars['return_current_url']->value)), ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>" <?php if ($_smarty_tpl->tpl_vars['settings']->value['Security']['secure_auth']!="Y") {?> data-ca-target-id="login_block<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['snapping_id'], ENT_QUOTES, 'ISO-8859-1');?>
