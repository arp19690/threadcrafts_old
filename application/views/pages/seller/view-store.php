                    ...
                    <div class="accordion-group">
                        ...
                        <div id="filterPrices" class="accordion-body in collapse" data-currency="<?php echo DEFAULT_CURRENCY_SYMBOL; ?>">
                            <div class="accordion-inner with-slider">
                                ...
                                <input type="text" data-initial="<?php echo ceil($price_range_array['max_price']); ?>" class="max-val pull-right" disabled />
                                <input type="text" data-initial="<?php echo round($price_range_array['min_price']); ?>" class="min-val" disabled />
                            </div>
                        </div>
                    </div> <!-- /prices slider -->
...
//                                    prd($value);
                                                ...
                                                <div class="product-img">
                                                    <div class="picture">
                                                        ...
                                                        <div class="img-overlay">
                                                            <a class="btn more btn-primary" href="<?php echo getProductUrl($product_id); ?>" target="_blank">View</a>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <?php
                        if ($no_results_found)
                            echo '<div class="span5"><p>No products found.</p></div>';
                    ?>
                </div>
                <hr />
