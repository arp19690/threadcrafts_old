<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 15:08:36
         compiled from "/var/www/html/design/backend/templates/addons/news_and_emails/views/news/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:131119871455aa1e9c916d51-17328113%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bf35057db27d5499d7faed5d749534430325eb55' => 
    array (
      0 => '/var/www/html/design/backend/templates/addons/news_and_emails/views/news/update.tpl',
      1 => 1437201145,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '131119871455aa1e9c916d51-17328113',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa1e9c9f6020_91351292',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa1e9c9f6020_91351292')) {function content_55aa1e9c9f6020_91351292($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
?><?php
...
<input type="hidden" class="cm-no-hide-input" name="news_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
<input type="hidden" class="cm-no-hide-input" name="selected_section" value="<?php echo htmlspecialchars((($tmp = @$_REQUEST['selected_section'])===null||$tmp==='' ? "detailed" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
" />
...
<fieldset>
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" name="news_data[news]" id="elm_news_name" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['news_data']->value['news'], ENT_QUOTES, 'ISO-8859-1');?>
" size="40" class="input-large" />
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <textarea id="elm_news_description" name="news_data[description]" cols="35" rows="8" class="cm-wysiwyg input-large"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['news_data']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
        </div>
    </div>
