<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 19:27:55
         compiled from "/var/www/html/design/themes/responsive/templates/views/product_features/compare.tpl" */ ?>
<?php /*%%SmartyHeaderCode:33415810055aa5b6329f371-84384507%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fd14fee60bb343d081a1de6525e1415c5e16561f' => 
    array (
      0 => '/var/www/html/design/themes/responsive/templates/views/product_features/compare.tpl',
      1 => 1437201213,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '33415810055aa5b6329f371-84384507',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa5b635252a6_94712366',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa5b635252a6_94712366')) {function content_55aa5b635252a6_94712366($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/app/functions/smarty_plugins/function.script.php';
...
?>
                    <td class="ty-compare-products__product">
                        <div class="ty-compare-products__item">
                            <div class="ty-compare-products__delete"><a href="<?php echo htmlspecialchars(fn_url("product_features.delete_product?product_id=".((string)$_smarty_tpl->tpl_vars['product']->value['product_id'])."&redirect_url=".((string)$_smarty_tpl->tpl_vars['return_current_url']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
"><i class="ty-remove__icon ty-icon-cancel-circle"></i><span class="ty-remove__txt"><?php echo $_smarty_tpl->__("remove");?>
                            ...
                            <div class="ty-compare-products__img"><a href="<?php echo htmlspecialchars(fn_url("products.view?product_id=".((string)$_smarty_tpl->tpl_vars['product']->value['product_id'])), ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['feature']->value['prefix']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['prefix'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?><?php if ($_smarty_tpl->tpl_vars['feature']->value['feature_type']=="C") {?><span class="ty-compare-checkbox" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['value'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php if ($_smarty_tpl->tpl_vars['feature']->value['value']=="Y") {?><i class="ty-compare-checkbox__icon ty-icon-ok"></i><?php }?></span><?php } elseif ($_smarty_tpl->tpl_vars['feature']->value['feature_type']=="D") {?><?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['feature']->value['value_int'],((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['date_format'])), ENT_QUOTES, 'ISO-8859-1');?>
...
?><?php if ($_smarty_tpl->tpl_vars['var']->value['selected']) {?><li class="ty-compare-list__item"><span class="ty-compare-checkbox" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['var']->value['variant'], ENT_QUOTES, 'ISO-8859-1');?>
"><i class="ty-compare-checkbox__icon ty-icon-ok"></i></span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['var']->value['variant'], ENT_QUOTES, 'ISO-8859-1');?>
...
foreach ($_from as $_smarty_tpl->tpl_vars["var"]->key => $_smarty_tpl->tpl_vars["var"]->value) {
$_smarty_tpl->tpl_vars["var"]->_loop = true;
?><?php if ($_smarty_tpl->tpl_vars['var']->value['selected']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['var']->value['variant'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?><?php } ?><?php } elseif ($_smarty_tpl->tpl_vars['feature']->value['feature_type']=="N"||$_smarty_tpl->tpl_vars['feature']->value['feature_type']=="O") {?><?php echo htmlspecialchars((($tmp = @floatval($_smarty_tpl->tpl_vars['feature']->value['value_int']))===null||$tmp==='' ? "-" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
<?php } else { ?><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['feature']->value['value'])===null||$tmp==='' ? "-" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
<?php }?><?php if ($_smarty_tpl->tpl_vars['feature']->value['suffix']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['suffix'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>
                            <?php } ?>
                        </tr>
                    <?php } ?>
