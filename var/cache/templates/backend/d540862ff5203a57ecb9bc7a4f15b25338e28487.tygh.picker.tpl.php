<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 12:35:20
         compiled from "/var/www/html/design/backend/templates/pickers/categories/picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:170184626855a9fab0517ec8-86406811%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd540862ff5203a57ecb9bc7a4f15b25338e28487' => 
    array (
  ...
  'nocache_hash' => '170184626855a9fab0517ec8-86406811',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9fab0694f75_19200912',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9fab0694f75_19200912')) {function content_55a9fab0694f75_19200912($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/app/lib/other/smarty/plugins/function.math.php';
...
" title="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['but_text']->value)===null||$tmp==='' ? $_smarty_tpl->__("add_categories") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
"></div>
            <?php }?>
...
" class="<?php if ($_smarty_tpl->tpl_vars['multiple']->value&&!$_smarty_tpl->tpl_vars['item_ids']->value) {?>hidden<?php } elseif (!$_smarty_tpl->tpl_vars['multiple']->value) {?><?php if ($_smarty_tpl->tpl_vars['view_mode']->value!="list") {?>cm-display-radio<?php }?><?php }?> choose-category">
    ...
    <?php }?>
            <input id="<?php if ($_smarty_tpl->tpl_vars['input_id']->value) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
<?php } else { ?>c<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" value="<?php if (is_array($_smarty_tpl->tpl_vars['item_ids']->value)) {?><?php echo htmlspecialchars(implode(",",$_smarty_tpl->tpl_vars['item_ids']->value), ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>" <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['extra']->value, ENT_QUOTES, 'ISO-8859-1');?>
 />
    <?php if ($_smarty_tpl->tpl_vars['multiple']->value) {?>
            </td>
        </tr>
