<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 12:35:20
         compiled from "/var/www/html/design/backend/templates/views/products/components/products_update_qty_discounts.tpl" */ ?>
<?php /*%%SmartyHeaderCode:143413237755a9fab0b26758-92805697%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b85f8ca69ff16dc1cee2321e4c1f5ed5d9db1acc' => 
    array (
  ...
  'nocache_hash' => '143413237755a9fab0b26758-92805697',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9fab0c51416_43136261',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9fab0c51416_43136261')) {function content_55a9fab0c51416_43136261($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/app/lib/other/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_cycle')) include '/var/www/html/app/lib/other/smarty/plugins/function.cycle.php';
?><?php
...
">
            <?php if ($_smarty_tpl->tpl_vars['price']->value['lower_limit']=="1"&&$_smarty_tpl->tpl_vars['price']->value['usergroup_id']=="0") {?>
                &nbsp;<?php if ($_smarty_tpl->tpl_vars['price']->value['percentage_discount']==0) {?><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['price']->value['price'])===null||$tmp==='' ? "0.00" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
<?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['price']->value['percentage_discount'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>
            <?php } else { ?>
            <input type="text" name="product_data[prices][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
][price]" value="<?php if ($_smarty_tpl->tpl_vars['price']->value['percentage_discount']==0) {?><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['price']->value['price'])===null||$tmp==='' ? "0.00" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
<?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['price']->value['percentage_discount'], ENT_QUOTES, 'ISO-8859-1');?>
...
" selected="selected"><?php if ($_smarty_tpl->tpl_vars['default_usergroup_name']->value) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['default_usergroup_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
<?php } else { ?><?php echo htmlspecialchars(fn_get_usergroup_name($_smarty_tpl->tpl_vars['price']->value['usergroup_id']), ENT_QUOTES, 'ISO-8859-1');?>
<?php }?></option>
            </select>
...
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['no_hide_input_if_shared_product']->value, ENT_QUOTES, 'ISO-8859-1');?>
