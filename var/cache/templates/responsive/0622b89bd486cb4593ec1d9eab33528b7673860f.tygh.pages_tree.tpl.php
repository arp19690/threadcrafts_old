<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 19:24:39
         compiled from "/var/www/html/design/themes/responsive/templates/views/pages/components/pages_tree.tpl" */ ?>
<?php /*%%SmartyHeaderCode:128801612955aa5a9f4a2e19-91603330%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '128801612955aa5a9f4a2e19-91603330',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa5a9f530ea8_58087546',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa5a9f530ea8_58087546')) {function content_55aa5a9f530ea8_58087546($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/app/lib/other/smarty/plugins/function.math.php';
...
?>
    ...
    <li>
        <a href="<?php if ($_smarty_tpl->tpl_vars['page']->value['page_type']==@constant('PAGE_TYPE_LINK')) {?><?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['page']->value['link']), ENT_QUOTES, 'ISO-8859-1');?>
<?php } else { ?><?php echo htmlspecialchars(fn_url("pages.view?page_id=".((string)$_smarty_tpl->tpl_vars['page']->value['page_id'])), ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>"<?php if ($_smarty_tpl->tpl_vars['page']->value['new_window']) {?> target="_blank"<?php }?><?php if ($_smarty_tpl->tpl_vars['page']->value['level']!="0") {?> style="padding-left: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shift']->value, ENT_QUOTES, 'ISO-8859-1');?>
