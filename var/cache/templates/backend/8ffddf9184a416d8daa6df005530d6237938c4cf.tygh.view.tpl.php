<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 12:20:01
         compiled from "/var/www/html/design/backend/templates/views/settings_wizard/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:25644047955a9f719474139-84587787%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8ffddf9184a416d8daa6df005530d6237938c4cf' => 
    array (
      0 => '/var/www/html/design/backend/templates/views/settings_wizard/view.tpl',
      1 => 1437201145,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '25644047955a9f719474139-84587787',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9f71953aed4_19846773',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9f71953aed4_19846773')) {function content_55a9f71953aed4_19846773($_smarty_tpl) {?><?php
...
<form name="settings_wizard_form" method="post" action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
...
">
    ...
    <div id="settings_wizard">
        <input type="hidden" name="current_step" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['current_step']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
/addons/<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['addon_name'], ENT_QUOTES, 'ISO-8859-1');?>
/icon.png" width="38" height="38" border="0" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['addon']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['addon']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
" >
                                    <?php }?>
                                </div>
                            </td>
                            <td width="95%">
                                <div class="object-group-link-wrap">
                                    <span class="unedited-element block"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['addon']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</span><br>
                                    <span class="row-status object-group-details"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['addon']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</span>
                                </div>
                            </td>
                            <td width="5%">
                                <input type="hidden" name="addons[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['addon_name'], ENT_QUOTES, 'ISO-8859-1');?>
]" value="N">
                                <label for="addon_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['addon_name'], ENT_QUOTES, 'ISO-8859-1');?>
" class="checkbox">
                                    <input id="addon_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['addon_name'], ENT_QUOTES, 'ISO-8859-1');?>
" type="checkbox" name="addons[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['addon_name'], ENT_QUOTES, 'ISO-8859-1');?>
        ...
        <script type="text/javascript">
            ...
            Tygh.$('#settings_wizard').appear(function()<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ldelim']->value, ENT_QUOTES, 'ISO-8859-1');?>
Tygh.$.ceDialog('get_last').ceDialog('change_title', '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['popup_title']->value, ENT_QUOTES, 'ISO-8859-1');?>
