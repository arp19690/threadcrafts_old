...
<?php /*%%SmartyHeaderCode:191263557455a9f393eba7a1-42509852%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '191263557455a9f393eba7a1-42509852',
  'function' => 
  array (
    'menu_attrs' => 
    array (
  ...
  'unifunc' => 'content_55a9f3941a59a7_75740220',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9f3941a59a7_75740220')) {function content_55a9f3941a59a7_75740220($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
        ...
        <?php if (fn_allowed_for("ULTIMATE")) {?>
            <div class="nav-ult">
                ...
                <?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_data']['storefront']) {?>
                    <a href="<?php echo htmlspecialchars(fn_url("?company_id=".((string)$_smarty_tpl->tpl_vars['runtime']->value['company_data']['company_id']),"C"), ENT_QUOTES, 'ISO-8859-1');?>
...
...</a></li>
        ...
        <?php if (fn_allowed_for("MULTIVENDOR")&&!$_smarty_tpl->tpl_vars['runtime']->value['simple_ultimate']) {?>
            <ul class="nav">
                <a href="<?php echo htmlspecialchars(htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['config']->value['http_location']), ENT_QUOTES, 'ISO-8859-1', true), ENT_QUOTES, 'ISO-8859-1');?>
" target="_blank" class="brand" title="<?php echo $_smarty_tpl->__("view_storefront");?>
">
                    <i class="icon-shopping-cart icon-white"></i>
                </a>
                <a href="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
" class="brand"><?php echo htmlspecialchars(smarty_modifier_truncate($_smarty_tpl->tpl_vars['settings']->value['Company']['company_name'],60,"...",true), ENT_QUOTES, 'ISO-8859-1');?>
</a>
...
</strong><br><?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['use_email_as_login']=="Y") {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_info']->value['email'], ENT_QUOTES, 'ISO-8859-1');?>
<?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_info']->value['user_login'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?></a>
                        </li>
                        <li class="divider"></li>
...
"><?php echo $_smarty_tpl->__("sign_out");?>
    ...
    <!--Subnav-->
    <div class="subnav cm-sticky-scroll" data-ce-top="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sticky_scroll']->value, ENT_QUOTES, 'ISO-8859-1');?>
" data-ce-padding="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sticky_padding']->value, ENT_QUOTES, 'ISO-8859-1');?>
" id="header_subnav">
        <!--quick search-->
...
" id="search_button"><?php echo $_smarty_tpl->__("go");?>
                    ...
                    <label for="gs_text"><a><input type="text" class="cm-autocomplete-off" id="gs_text" name="q" value="<?php echo htmlspecialchars($_REQUEST['q'], ENT_QUOTES, 'ISO-8859-1');?>
" /></a></label>
                </form>
        ...
        <ul class="nav hover-show nav-pills">
            <li><a href="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
