...
<?php /*%%SmartyHeaderCode:82982249655aa6cdfaff1e5-35348922%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '82982249655aa6cdfaff1e5-35348922',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa6cdfbd1874_80977848',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa6cdfbd1874_80977848')) {function content_55aa6cdfbd1874_80977848($_smarty_tpl) {?><?php if (!is_callable('smarty_function_render_block')) include '/var/www/html/app/functions/smarty_plugins/function.render_block.php';
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
            ...
            <?php if (trim(Smarty::$_smarty_vars['capture'][$_smarty_tpl->tpl_vars['tab_content_capture']->value])) {?>
                <?php if ($_smarty_tpl->tpl_vars['settings']->value['Appearance']['product_details_in_tab']=="N") {?>
                    <h3 class="tab-list-title"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tab']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</h3>
                <?php }?>
            <?php }?>
