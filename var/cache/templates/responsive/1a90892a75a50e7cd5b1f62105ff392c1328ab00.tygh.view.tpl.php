<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 15:34:11
         compiled from "/var/www/html/design/themes/responsive/templates/addons/discussion/views/discussion/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:117787238355aa249b6e0007-99576105%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1a90892a75a50e7cd5b1f62105ff392c1328ab00' => 
    array (
      0 => '/var/www/html/design/themes/responsive/templates/addons/discussion/views/discussion/view.tpl',
      1 => 1437201218,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '117787238355aa249b6e0007-99576105',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa249b822384_95790899',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa249b822384_95790899')) {function content_55aa249b822384_95790899($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
...
<?php if ($_smarty_tpl->tpl_vars['discussion']->value&&$_smarty_tpl->tpl_vars['discussion']->value['type']!="D") {?>
    <div class="discussion-block" id="<?php if ($_smarty_tpl->tpl_vars['container_id']->value) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['container_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
        ...
        <?php } else { ?>
            <?php $_smarty_tpl->_capture_stack[0][] = array("mainbox_title", null, null); ob_start(); ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['title']->value, ENT_QUOTES, 'ISO-8859-1');?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
