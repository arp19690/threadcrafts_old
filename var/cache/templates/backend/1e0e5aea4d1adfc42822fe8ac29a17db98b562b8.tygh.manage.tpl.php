<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 15:29:29
         compiled from "/var/www/html/design/backend/templates/views/companies/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:199252864755aa23812ae951-68868026%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1e0e5aea4d1adfc42822fe8ac29a17db98b562b8' => 
    array (
  ...
  'nocache_hash' => '199252864755aa23812ae951-68868026',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa2381471830_50330493',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa2381471830_50330493')) {function content_55aa2381471830_50330493($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_unpuny')) include '/var/www/html/app/functions/smarty_plugins/modifier.unpuny.php';
...
" class="cm-item" /></td>
    <td class="row-status"><a href="<?php echo htmlspecialchars(fn_url("companies.update?company_id=".((string)$_smarty_tpl->tpl_vars['company']->value['company_id'])), ENT_QUOTES, 'ISO-8859-1');?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company']->value['company'], ENT_QUOTES, 'ISO-8859-1');?>
    ...
    <?php if (!fn_allowed_for("ULTIMATE")) {?>
        <td class="row-status"><a href="mailto:<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company']->value['email'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company']->value['email'], ENT_QUOTES, 'ISO-8859-1');?>
</a></td>
    <?php }?>
    <?php if (fn_allowed_for("ULTIMATE")) {?>
        <td><a href="http://<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company']->value['storefront'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars(smarty_modifier_unpuny($_smarty_tpl->tpl_vars['company']->value['storefront']), ENT_QUOTES, 'ISO-8859-1');?>
</a></td>
    <?php }?>
    <td class="row-status"><?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['company']->value['timestamp'],((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['date_format']).", ".((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['time_format'])), ENT_QUOTES, 'ISO-8859-1');?>
</td>
    <td class="nowrap">
