<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 19:29:02
         compiled from "/var/www/html/design/themes/responsive/templates/views/products/components/product_filters_advanced_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:118169119655aa5ba69374d0-71603243%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4262993b64308a33796255fa399e297b30dc1ddf' => 
    array (
      0 => '/var/www/html/design/themes/responsive/templates/views/products/components/product_filters_advanced_form.tpl',
      1 => 1437201213,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '118169119655aa5ba69374d0-71603243',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa5ba6e00f09_05550730',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa5ba6e00f09_05550730')) {function content_55aa5ba6e00f09_05550730($_smarty_tpl) {?><?php if (!is_callable('smarty_function_split')) include '/var/www/html/app/functions/smarty_plugins/function.split.php';
...
<input type="hidden" name="category_id" value="<?php echo htmlspecialchars($_REQUEST['category_id'], ENT_QUOTES, 'ISO-8859-1');?>
" />
<input type="hidden" name="subcats" value="Y" />
<?php }?>

<?php if ($_REQUEST['variant_id']) {?>
<input type="hidden" name="variant_id" value="<?php echo htmlspecialchars($_REQUEST['variant_id'], ENT_QUOTES, 'ISO-8859-1');?>
" />
<?php }?>
...
?>
        ...
        <div class="ty-column4">
            <div class="ty-filters-search__item">
                ...
                <div class="ty-filters-search__title"><?php echo htmlspecialchars((($tmp = @(($tmp = @$_smarty_tpl->tpl_vars['filter']->value['filter'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['filter']->value['description'] : $tmp))===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</div>
...
?>
                        <div class="ty-select-field"><input type="checkbox" class="ty-select-field__checkbox" name="<?php if ($_smarty_tpl->tpl_vars['filter']->value['feature_type']=="M") {?>multiple_<?php }?>variants[]" id="variants_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['range']->value['range_id'], ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php if ($_smarty_tpl->tpl_vars['filter']->value['feature_type']=="M") {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['range']->value['range_id'], ENT_QUOTES, 'ISO-8859-1');?>
<?php } else { ?>[V<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['range']->value['range_id'], ENT_QUOTES, 'ISO-8859-1');?>
...
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['range']->value['range_name'], ENT_QUOTES, 'ISO-8859-1');?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['suffix'], ENT_QUOTES, 'ISO-8859-1');?>
                ...
                <?php } elseif ($_smarty_tpl->tpl_vars['filter']->value['feature_type']=="O"||$_smarty_tpl->tpl_vars['filter']->value['feature_type']=="N"||$_smarty_tpl->tpl_vars['filter']->value['feature_type']=="D"||$_smarty_tpl->tpl_vars['filter']->value['condition_type']=="D"||$_smarty_tpl->tpl_vars['filter']->value['condition_type']=="F") {?>
                    ...
                    <?php }?>
                        ...
                        <?php }?>
                        <p<?php if (!$_smarty_tpl->tpl_vars['filter']->value['slider']) {?> class="ty-select-field"<?php }?>><input type="radio" name="variants[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" id="no_ranges_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" value="" checked="checked" class="radio ty-select-field__checkbox" /><label class="ty-select-field__title" for="no_ranges_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                                ...
                                <div class="ty-select-field"><input type="radio" class="ty-select-field__checkbox" name="variants[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" id="ranges_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['range']->value['range_id'], ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_type']->value, ENT_QUOTES, 'ISO-8859-1');?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['range']->value['range_id'], ENT_QUOTES, 'ISO-8859-1');?>
...
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['range']->value['range_id'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars(fn_text_placeholders($_smarty_tpl->tpl_vars['range']->value['range_name']), ENT_QUOTES, 'ISO-8859-1');?>
</label></div>
                            <?php } ?>
                        <?php }?>
                    <?php if (!$_smarty_tpl->tpl_vars['filter']->value['slider']) {?>
                    ...
                    <p><input type="radio" name="variants[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" id="select_custom_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" value="O" <?php if ($_smarty_tpl->tpl_vars['search']->value['variants'][$_smarty_tpl->tpl_vars['el_id']->value]=="O") {?>checked="checked"<?php }?> class="radio" /><label for="select_custom_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("your_range");?>
                    ...
                    <div class="ty-select-field">
                        <?php if ($_smarty_tpl->tpl_vars['filter']->value['feature_type']=="D") {?>
                            ...
                            <input type="hidden" name="custom_range[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['feature_id'], ENT_QUOTES, 'ISO-8859-1');?>
][type]" value="D" />
                        <?php } else { ?>
                            <?php if (!$_smarty_tpl->tpl_vars['filter']->value['slider']) {?>
                            ...
                            <input type="text" name="<?php if ($_smarty_tpl->tpl_vars['filter']->value['field_type']) {?>field_range[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['field_type'], ENT_QUOTES, 'ISO-8859-1');?>
]<?php } else { ?>custom_range[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['feature_id'], ENT_QUOTES, 'ISO-8859-1');?>
]<?php }?>[from]" id="range_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_from" size="3" class="ty-input-text-short<?php if ($_smarty_tpl->tpl_vars['search']->value['variants'][$_smarty_tpl->tpl_vars['el_id']->value]!="O") {?> disabled<?php }?>" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['from_value']->value, ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['search']->value['variants'][$_smarty_tpl->tpl_vars['el_id']->value]!="O") {?>disabled="disabled"<?php }?> />
                            &nbsp;-&nbsp;
                            <input type="text" name="<?php if ($_smarty_tpl->tpl_vars['filter']->value['field_type']) {?>field_range[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['field_type'], ENT_QUOTES, 'ISO-8859-1');?>
]<?php } else { ?>custom_range[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['feature_id'], ENT_QUOTES, 'ISO-8859-1');?>
]<?php }?>[to]" size="3" class="ty-input-text-short<?php if ($_smarty_tpl->tpl_vars['search']->value['variants'][$_smarty_tpl->tpl_vars['el_id']->value]!="O") {?> disabled<?php }?>" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['to_value']->value, ENT_QUOTES, 'ISO-8859-1');?>
" id="range_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_to" <?php if ($_smarty_tpl->tpl_vars['search']->value['variants'][$_smarty_tpl->tpl_vars['el_id']->value]!="O") {?>disabled="disabled"<?php }?> />
                            <?php if ($_smarty_tpl->tpl_vars['filter']->value['field_type']=='P') {?>
                                <input type="hidden" name="field_range[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['field_type'], ENT_QUOTES, 'ISO-8859-1');?>
][cur]" size="3" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cur']->value, ENT_QUOTES, 'ISO-8859-1');?>
" id="range_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_cur" <?php if ($_smarty_tpl->tpl_vars['search']->value['variants'][$_smarty_tpl->tpl_vars['el_id']->value]!="O") {?>disabled="disabled"<?php }?> />
                                <input type="hidden" name="field_range[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['field_type'], ENT_QUOTES, 'ISO-8859-1');?>
][orig_from]" size="3" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['orig_from']->value, ENT_QUOTES, 'ISO-8859-1');?>
" id="range_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_orig_from" <?php if ($_smarty_tpl->tpl_vars['search']->value['variants'][$_smarty_tpl->tpl_vars['el_id']->value]!="O") {?>disabled="disabled"<?php }?> />
                                <input type="hidden" name="field_range[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['field_type'], ENT_QUOTES, 'ISO-8859-1');?>
][orig_to]" size="3"  value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['orig_to']->value, ENT_QUOTES, 'ISO-8859-1');?>
" id="range_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_orig_to" <?php if ($_smarty_tpl->tpl_vars['search']->value['variants'][$_smarty_tpl->tpl_vars['el_id']->value]!="O") {?>disabled="disabled"<?php }?> />
                                <input type="hidden" name="field_range[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['field_type'], ENT_QUOTES, 'ISO-8859-1');?>
][orig_cur]" size="3" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['orig_cur']->value, ENT_QUOTES, 'ISO-8859-1');?>
" id="range_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_orig_cur" <?php if ($_smarty_tpl->tpl_vars['search']->value['variants'][$_smarty_tpl->tpl_vars['el_id']->value]!="O") {?>disabled="disabled"<?php }?> />
                    ...
                    Tygh.$(document).ready(function()<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ldelim']->value, ENT_QUOTES, 'ISO-8859-1');?>
                        ...
                        var $ = Tygh.$;
                        $('input[type=radio][name="variants[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
]"]').change(function() {
                            var el_id = '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
';
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['filter']->value['field_type']=='P') {?>
                            $('#range_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_to').change(function() {
                                $('#range_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_orig_cur').val('');
                            });
...
_orig_cur').val('');
                ...
                <?php } elseif ($_smarty_tpl->tpl_vars['filter']->value['feature_type']=="C"||$_smarty_tpl->tpl_vars['filter']->value['condition_type']=="C") {?>
                    ...
                    <?php }?>
                    <div class="ty-select-field">
                        <input type="radio ty-select-field__checkbox" class="radio" name="ch_filters[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" id="ranges_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_none" value="" <?php if (!$_smarty_tpl->tpl_vars['search']->value['ch_filters'][$_smarty_tpl->tpl_vars['el_id']->value]) {?>checked="checked"<?php }?> />
                        <label class="ty-select-field__title" for="ranges_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
_no"><?php echo $_smarty_tpl->__("no");?>
                    ...
                    <?php if (!$_smarty_tpl->tpl_vars['filter']->value['condition_type']) {?>
                    <div class="ty-select-field">
                        <input type="radio" class="radio ty-select-field__checkbox" name="ch_filters[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" id="ranges_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['el_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
_any"><?php echo $_smarty_tpl->__("any");?>
                ...
                <?php } elseif ($_smarty_tpl->tpl_vars['filter']->value['feature_type']=="T") {?>
                    ...
                    <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['prefix'], ENT_QUOTES, 'ISO-8859-1');?>
<input type="text" name="tx_features[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['feature_id'], ENT_QUOTES, 'ISO-8859-1');?>
]" class="ty-filters-search__input-text<?php if ($_smarty_tpl->tpl_vars['filter']->value['prefix']||$_smarty_tpl->tpl_vars['filter']->value['suffix']) {?>-medium<?php }?>" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['tx_features'][$_smarty_tpl->tpl_vars['filter']->value['feature_id']], ENT_QUOTES, 'ISO-8859-1');?>
" /><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['suffix'], ENT_QUOTES, 'ISO-8859-1');?>
...
<?php } elseif ($_smarty_tpl->tpl_vars['search']->value['features_hash']) {?>
    <input type="hidden" name="features_hash" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['features_hash'], ENT_QUOTES, 'ISO-8859-1');?>
" />
