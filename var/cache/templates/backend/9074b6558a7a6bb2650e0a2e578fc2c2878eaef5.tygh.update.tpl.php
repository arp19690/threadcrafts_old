<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 09:42:02
         compiled from "/var/www/html/design/backend/templates/views/profiles/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:97520589955a9f53a55de51-51867450%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9074b6558a7a6bb2650e0a2e578fc2c2878eaef5' => 
    array (
      0 => '/var/www/html/design/backend/templates/views/profiles/update.tpl',
      1 => 1437201145,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '97520589955a9f53a55de51-51867450',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9f53a76cba1_59757971',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9f53a76cba1_59757971')) {function content_55a9f53a76cba1_59757971($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
?><?php
...
?>
                    <tr>
                        <td><a href="<?php echo htmlspecialchars(fn_url("usergroups.manage#group".((string)$_smarty_tpl->tpl_vars['usergroup']->value['usergroup_id'])), ENT_QUOTES, 'ISO-8859-1');?>
        ...
        <div id="content_api">
            ...
            <div id="api_container" <?php if ($_smarty_tpl->tpl_vars['user_data']->value['api_key']=='') {?>class="hidden"<?php }?>>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="input-large" name="user_data[api_key]" value="<?php if ($_smarty_tpl->tpl_vars['user_data']->value['api_key']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['api_key'], ENT_QUOTES, 'ISO-8859-1');?>
<?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['new_api_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
