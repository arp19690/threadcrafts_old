<?php /* Smarty version Smarty-3.1.18, created on 2015-08-11 09:54:26
         compiled from "/var/www/html/design/backend/templates/pickers/companies/picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:86656433655c978fa7c1fc6-79012454%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'db4f676c5f7a8ea08c91ed016072c66a3b5b87bd' => 
    array (
      0 => '/var/www/html/design/backend/templates/pickers/companies/picker.tpl',
      1 => 1439189760,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '86656433655c978fa7c1fc6-79012454',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55c978fa97d917_35967507',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55c978fa97d917_35967507')) {function content_55c978fa97d917_35967507($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/app/lib/other/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_script')) include '/var/www/html/app/functions/smarty_plugins/function.script.php';
?><?php
fn_preload_lang_vars(array('add_companies','choose','add_companies','choose','add_companies','add_companies','add_companies','position_short','name','no_items'));
?>
...
<?php } else { ?>m<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'UTF-8');?>
...
" value="<?php if (is_array($_smarty_tpl->tpl_vars['item_ids']->value)) {?><?php $_smarty_tpl->tpl_vars["_item_ids"] = new Smarty_variable($_smarty_tpl->tpl_vars['item_ids']->value, null, 0);?><?php echo htmlspecialchars(implode(",",$_smarty_tpl->tpl_vars['_item_ids']->value), ENT_QUOTES, 'UTF-8');?>
