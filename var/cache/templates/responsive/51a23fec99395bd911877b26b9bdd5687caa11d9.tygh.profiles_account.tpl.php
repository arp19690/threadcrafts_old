<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 19:25:17
         compiled from "/var/www/html/design/themes/responsive/templates/views/profiles/components/profiles_account.tpl" */ ?>
<?php /*%%SmartyHeaderCode:49163185855aa5ac50038f7-87958589%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '51a23fec99395bd911877b26b9bdd5687caa11d9' => 
    array (
      0 => '/var/www/html/design/themes/responsive/templates/views/profiles/components/profiles_account.tpl',
      1 => 1437201213,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '49163185855aa5ac50038f7-87958589',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa5ac507e061_05701912',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa5ac507e061_05701912')) {function content_55aa5ac507e061_05701912($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
...
<?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"profiles:account_info")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"profiles:account_info"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['use_email_as_login']!="Y") {?>
        <div class="ty-control-group">
            ...
            <input id="user_login_profile" type="text" name="user_data[user_login]" size="32" maxlength="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['user_login'], ENT_QUOTES, 'ISO-8859-1');?>
" class="ty-input-text" />
        </div>
    <?php }?>
