<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 09:42:59
         compiled from "/var/www/html/design/backend/templates/views/themes/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:151305130555a9f5731891f2-40804000%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b72549cd57a0a949e39f64427ca9e3c79858f856' => 
    array (
      0 => '/var/www/html/design/backend/templates/views/themes/manage.tpl',
      1 => 1437201145,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '151305130555a9f5731891f2-40804000',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9f5733f3167_71942855',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9f5733f3167_71942855')) {function content_55a9f5733f3167_71942855($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/app/functions/smarty_plugins/function.script.php';
...
<?php if ($_smarty_tpl->tpl_vars['theme']->value['screenshot']) {?>
    <div id="theme_image">
        <?php if ($_smarty_tpl->tpl_vars['theme']->value['styles'][$_smarty_tpl->tpl_vars['layout']->value['style_id']]['image']) {?>
            <img class="span4 screenshot" width="250" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme']->value['styles'][$_smarty_tpl->tpl_vars['layout']->value['style_id']]['image'], ENT_QUOTES, 'ISO-8859-1');?>
">
        <?php } else { ?>
            <img class="span4 screenshot" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['images_dir']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
<?php if ($_smarty_tpl->tpl_vars['layout']->value['style_name']) {?>: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['layout']->value['style_name'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?></h4>
...
?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['installed_theme']->value) {?>
            <div class="theme-subtitle">
                ...
                <a class="cm-confirm cm-tooltip btn pull-right btn-small" data-ce-tooltip-position="top" href="<?php echo htmlspecialchars(fn_url("themes.delete?theme_name=".((string)$_smarty_tpl->tpl_vars['theme_name']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
"> <i class="icon-trash"></i> </a>
                ...
                <span class="label pull-right"><?php echo htmlspecialchars(count($_smarty_tpl->tpl_vars['installed_theme']->value['layouts']), ENT_QUOTES, 'ISO-8859-1');?>
 <?php echo $_smarty_tpl->__("layouts");?>
</span>
                <span class="label pull-right"><?php echo htmlspecialchars(count($_smarty_tpl->tpl_vars['installed_theme']->value['styles']), ENT_QUOTES, 'ISO-8859-1');?>
...
: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['style']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
                            ...
                            <div class="theme-use">
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['style']->value['style_id']==$_smarty_tpl->tpl_vars['layout']->value['style_id']&&$_smarty_tpl->tpl_vars['layout']->value['theme_name']==$_smarty_tpl->tpl_vars['theme_name']->value) {?>
                                    <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['style']->value['image'], ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-image-id="img_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" class="theme-in-use cm-previewer"><?php echo $_smarty_tpl->__("currently_in_use");?>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['style']->value['image']) {?>
                                <a id="image_img_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['style']->value['style_id'], ENT_QUOTES, 'ISO-8859-1');?>
...
" alt="" width="250"></a>
                    ...
                    <div class="theme-actions">
                        <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['repo_theme']->value['screenshot']) {?>
                            <li><a id="image_img_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['repo_theme']->value['screenshot'], ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-image-id="img_button_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-previewer"><?php echo $_smarty_tpl->__("preview");?>
</a></li>
                            <?php }?>

                            
                            <li><a class="cm-comet cm-ajax" data-ca-target-id="themes_list" href="<?php echo htmlspecialchars(fn_url("themes.install?theme_name=".((string)$_smarty_tpl->tpl_vars['theme_name']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
"></i>
        ...
        <div class="sidebar-row clearfix">
            ...
            <div class="row-fluid">
                ...
                <div class="span5 right"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme']->value['title'], ENT_QUOTES, 'ISO-8859-1');?>
</div>
            </div>
            <div class="row-fluid">
                <div class="span7 muted" title="/<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value['theme_name'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("directory");?>
</div>
                <div class="span5 right"><a class="pull-right" href="<?php echo htmlspecialchars(fn_url("file_editor.manage?active_section=themes&selected_path=".((string)$_smarty_tpl->tpl_vars['settings']->value['theme_name'])), ENT_QUOTES, 'ISO-8859-1');?>
">/<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value['theme_name'], ENT_QUOTES, 'ISO-8859-1');?>
            ...
            <div class="row-fluid">
                ...
                <div class="span5 right"><a href="<?php echo htmlspecialchars(fn_url("block_manager.manage"), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars(count($_smarty_tpl->tpl_vars['theme']->value['layouts']), ENT_QUOTES, 'ISO-8859-1');?>
</a></div>
            </div>
            <div class="row-fluid">
                <div class="span7 muted"><?php echo $_smarty_tpl->__("theme_editor.styles");?>
</div>
                <div class="span5 right"><a href="#anchor_<?php echo htmlspecialchars(smarty_modifier_replace($_smarty_tpl->tpl_vars['theme']->value['title'],' ','_'), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars(count($_smarty_tpl->tpl_vars['theme']->value['styles']), ENT_QUOTES, 'ISO-8859-1');?>
</a> </div>
            </div>
            <div class="row-fluid">
                <div class="span7 muted" ><?php echo $_smarty_tpl->__("developer");?>
</div>
                <div class="span5 right"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme']->value['developer'], ENT_QUOTES, 'ISO-8859-1');?>
</div>
            </div>
        </div>
