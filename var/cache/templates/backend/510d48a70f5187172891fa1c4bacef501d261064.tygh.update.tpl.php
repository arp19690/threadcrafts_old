<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 20:40:22
         compiled from "/var/www/html/design/backend/templates/views/product_options/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:134896297655aa6c5e686208-02849615%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '510d48a70f5187172891fa1c4bacef501d261064' => 
    array (
  ...
  'nocache_hash' => '134896297655aa6c5e686208-02849615',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa6c5e9eabf7_88036262',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa6c5e9eabf7_88036262')) {function content_55aa6c5e9eabf7_88036262($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
...
" class="control-label cm-required"><?php echo $_smarty_tpl->__("name");?>
            ...
            <div class="controls">
            <input class="span9" type="text" name="option_data[option_name]" id="elm_option_name_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" name="option_data[description]" cols="55" rows="8" class="cm-wysiwyg span9"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option_data']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
            </div>
        </div>
...
" class="hand cm-combinations-options-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
 exicon-expand"></div><div id="off_st_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" alt="<?php echo $_smarty_tpl->__("expand_collapse_list");?>
" title="<?php echo $_smarty_tpl->__("expand_collapse_list");?>
...
<?php $_smarty_tpl->tpl_vars["vr"] = new Smarty_variable('', null, 0);?>
        <tbody class="hover cm-row-item <?php if ($_smarty_tpl->tpl_vars['option_data']->value['option_type']=="C") {?>hidden<?php }?>" id="box_add_variant_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
        <tr>
            <td class="cm-non-cb<?php if ($_smarty_tpl->tpl_vars['option_data']->value['option_type']=="C") {?> hidden<?php }?>">
                <input type="text" name="option_data[variants][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['num']->value, ENT_QUOTES, 'ISO-8859-1');?>
