<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 09:05:14
         compiled from "/var/www/html/design/themes/responsive/templates/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:127360278255a9ec9a82f152-48388201%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '48ea2f32fe53cb9ffcca63b778efeb01f116ec85' => 
    array (
  ...
  'nocache_hash' => '127360278255a9ec9a82f152-48388201',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9ec9a8cdd01_99766660',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9ec9a8cdd01_99766660')) {function content_55a9ec9a8cdd01_99766660($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
...
<!DOCTYPE html>
<html lang="<?php echo htmlspecialchars(@constant('CART_LANGUAGE'), ENT_QUOTES, 'ISO-8859-1');?>
">
<head>
...
?>
        <?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['bkt']['first']) {?><?php echo htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['i']->value['title']), ENT_QUOTES, 'ISO-8859-1');?>
<?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['bkt']['last']) {?> :: <?php }?><?php }?>
    <?php } ?>
    <?php if (!$_smarty_tpl->tpl_vars['skip_page_title']->value&&$_smarty_tpl->tpl_vars['location_data']->value['title']) {?><?php if (count($_smarty_tpl->tpl_vars['breadcrumbs']->value)>1) {?> - <?php }?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['location_data']->value['title'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>
<?php }?>
...
<title><?php echo trim(preg_replace('!\s+!', ' ',Smarty::$_smarty_vars['capture']['title']));?>
</title>
<?php echo $_smarty_tpl->getSubTemplate ("meta.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

<link href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['logos']->value['favicon']['image']['image_path'], ENT_QUOTES, 'ISO-8859-1');?>
" rel="shortcut icon" />
