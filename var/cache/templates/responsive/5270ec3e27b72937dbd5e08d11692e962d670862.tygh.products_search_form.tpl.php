<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 19:29:02
         compiled from "/var/www/html/design/themes/responsive/templates/views/products/components/products_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:73814661955aa5ba65d9773-70108950%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5270ec3e27b72937dbd5e08d11692e962d670862' => 
    array (
      0 => '/var/www/html/design/themes/responsive/templates/views/products/components/products_search_form.tpl',
      1 => 1437201213,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '73814661955aa5ba65d9773-70108950',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa5ba67f3600_24779808',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa5ba67f3600_24779808')) {function content_55aa5ba67f3600_24779808($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
...
" name="advanced_search_form" method="get" class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_meta']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['v']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
<?php }?>
<?php } ?>
<?php }?>
...
<div class="ty-control-group">
    ...
    <input type="text" name="q" size="38" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['q'], ENT_QUOTES, 'ISO-8859-1');?>
...
" <?php if ($_smarty_tpl->tpl_vars['cat']->value['disabled']) {?>disabled="disabled"<?php }?><?php if ($_smarty_tpl->tpl_vars['search']->value['cid']==$_smarty_tpl->tpl_vars['cat']->value['category_id']) {?> selected="selected"<?php }?> title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cat']->value['category'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo preg_replace('!^!m',str_repeat("&#166;&nbsp;&nbsp;&nbsp;&nbsp;",$_smarty_tpl->tpl_vars['cat']->value['level']),smarty_modifier_truncate(htmlspecialchars($_smarty_tpl->tpl_vars['cat']->value['category'], ENT_QUOTES, 'ISO-8859-1', true),50,"...",true));?>
</option>
            <?php } ?>
        </select>
    </div>
...
<?php if (!$_smarty_tpl->tpl_vars['simple_search_form']->value) {?>
    ...
    <div class="ty-control-group">
        <input type="hidden" name="company_id" id="company_id" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['search']->value['company_id'])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
" />
...
&nbsp;(<?php echo $_smarty_tpl->tpl_vars['currencies']->value[$_smarty_tpl->tpl_vars['primary_currency']->value]['symbol'];?>
        ...
        <input type="text" name="price_from" id="price_from" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['price_from'], ENT_QUOTES, 'ISO-8859-1');?>
" onfocus="this.select();" class="ty-search-form__input" size="30" />&nbsp;-&nbsp;<input type="text" name="price_to" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['price_to'], ENT_QUOTES, 'ISO-8859-1');?>
" onfocus="this.select();" class="ty-search-form__input" size="30" />
    </div>
    <?php }?>
...
&nbsp;(<?php if ($_smarty_tpl->tpl_vars['config']->value['localization']['weight_symbol']) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['localization']['weight_symbol'], ENT_QUOTES, 'ISO-8859-1');?>
<?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value['General']['weight_symbol'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>)</label>
...
" onfocus="this.select();" class="ty-search-form__input" size="30" />&nbsp;-&nbsp;<input type="text" name="weight_to" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['weight_to'], ENT_QUOTES, 'ISO-8859-1');?>
" onfocus="this.select();" class="ty-search-form__input" size="30" />
    </div>
