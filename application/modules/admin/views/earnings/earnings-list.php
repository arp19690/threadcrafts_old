                                        ...
                                        <div class="controls">
                                            <select name="seller_id" class="m-wrap required" required="required">
                                                ...
                                                <?php
                                                    ...
                                                    {
                                                        $selected = '';
                                                        if (isset($_GET['seller_id']) && !empty($_GET['seller_id']) && @$_GET['seller_id'] == $sValue['seller_id'])
                                                        {
                                                            $selected = ' selected="selected" ';
                                                        }
                                                        echo '<option value="' . $sValue['seller_id'] . '" ' . $selected . '>' . getSellerDisplayName($sValue['seller_fullname'], $sValue['seller_company_name']) . '</option>';
                                                    }
                                                ?>
                                            </select>
