<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 20:52:21
         compiled from "/var/www/html/design/themes/responsive/templates/views/checkout/components/payments/payment_methods.tpl" */ ?>
<?php /*%%SmartyHeaderCode:169882422555aa6f2d291811-64087185%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '169882422555aa6f2d291811-64087185',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa6f2d4d0f62_86231662',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa6f2d4d0f62_86231662')) {function content_55aa6f2d4d0f62_86231662($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/app/functions/smarty_plugins/function.script.php';
...
(function(_, $) {
    $(_.doc).on('click', '.cm-select-payment', function() {
        ...
        $.ceAjax('request', fn_url('<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['url']->value, ENT_QUOTES, 'ISO-8859-1');?>
&payment_id=' + self.val()), {
            result_ids: '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['result_ids']->value, ENT_QUOTES, 'ISO-8859-1');?>
',
            full_render: true
        });
    });
...
?>
            ...
            <li id="payments_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tab_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="ty-tabs__item<?php if ($_smarty_tpl->tpl_vars['tab_id']->value==$_smarty_tpl->tpl_vars['active_tab']->value||(!$_smarty_tpl->tpl_vars['active_tab']->value&&$_smarty_tpl->tpl_vars['payments']->value[$_smarty_tpl->tpl_vars['payment_id']->value])) {?> active<?php }?>">
                <a class="ty-tabs__a cm-ajax cm-ajax-full-render" data-ca-target-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['result_ids']->value, ENT_QUOTES, 'ISO-8859-1');?>
" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['url']->value)."?active_tab=".((string)$_smarty_tpl->tpl_vars['tab_id']->value)."&payment_id=".((string)$_smarty_tpl->tpl_vars['first_payment']->value['payment_id'])), ENT_QUOTES, 'ISO-8859-1');?>
...
$_smarty_tpl->tpl_vars["payments"]->_loop = true;
 $_smarty_tpl->tpl_vars["tab_id"]->value = $_smarty_tpl->tpl_vars["payments"]->key;
?>
        <div class="<?php if ($_smarty_tpl->tpl_vars['active']->value!=$_smarty_tpl->tpl_vars['tab_id']->value&&count($_smarty_tpl->tpl_vars['payment_methods']->value)>1) {?>hidden<?php }?>" id="content_payments_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tab_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
            <form name="payments_form_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tab_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
                        ...
                        <?php $_smarty_tpl->_capture_stack[0][] = array("payment_template", null, null); ob_start(); ?>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['payment']->value['description']) {?>
                                <div class="ty-payments-list__description">
                                    <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['payment']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['order_id']->value) {?>
                    ...
                    <div class="ty-checkout-buttons">
                        <?php if ($_smarty_tpl->tpl_vars['payment_method']->value['params']['button']) {?>
                            <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['payment_method']->value['params']['button'], ENT_QUOTES, 'ISO-8859-1');?>
...
" style="border: 0px" frameBorder="0" ></iframe>
                            ...
                            <div id="payment_method_iframe<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tab_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="ty-payment-method-iframe">
        ...
        <!--content_payments_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tab_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></div>
    <?php } ?>
</div>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
