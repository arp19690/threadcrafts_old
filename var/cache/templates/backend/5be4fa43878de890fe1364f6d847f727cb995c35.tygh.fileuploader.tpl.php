<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 09:42:59
         compiled from "/var/www/html/design/backend/templates/common/fileuploader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:168385374155a9f573432420-67803998%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5be4fa43878de890fe1364f6d847f727cb995c35' => 
    array (
  ...
  'nocache_hash' => '168385374155a9f573432420-67803998',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9f573524a47_87706208',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9f573524a47_87706208')) {function content_55a9f573524a47_87706208($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/app/functions/smarty_plugins/function.script.php';
...
(function(_, $) {
    $.extend(_, {
        post_max_size_bytes: '<?php echo htmlspecialchars(fn_return_bytes(ini_get("post_max_size")), ENT_QUOTES, 'ISO-8859-1');?>
',
        files_upload_max_size_bytes: '<?php echo htmlspecialchars(fn_return_bytes(ini_get("upload_max_filesize")), ENT_QUOTES, 'ISO-8859-1');?>
',

        post_max_size_mbytes: '<?php echo htmlspecialchars(ini_get("post_max_size"), ENT_QUOTES, 'ISO-8859-1');?>
',
        files_upload_max_size_mbytes: '<?php echo htmlspecialchars(ini_get("upload_max_filesize"), ENT_QUOTES, 'ISO-8859-1');?>
',
...
" value="<?php if ($_smarty_tpl->tpl_vars['images']->value) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_var_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>" />
...
" border="0" /></a><br />
            ...
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"fileuploader:uploaded_files")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"fileuploader:uploaded_files"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['delete_link']->value) {?><a class="cm-ajax" href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['delete_link']->value), ENT_QUOTES, 'ISO-8859-1');?>
"><?php }?><?php if (!($_smarty_tpl->tpl_vars['po']->value['required']=="Y"&&count($_smarty_tpl->tpl_vars['images']->value)==1)) {?><i id="clean_selection_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_var_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['image']->value['file'], ENT_QUOTES, 'ISO-8859-1');?>
...
');" class="icon-remove-sign cm-tooltip hand"></i>&nbsp;<?php }?><?php if ($_smarty_tpl->tpl_vars['delete_link']->value) {?></a><?php }?><span><?php if ($_smarty_tpl->tpl_vars['download_link']->value) {?><a href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['download_link']->value), ENT_QUOTES, 'ISO-8859-1');?>
"><?php }?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['image']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
...
" value="<?php if ($_smarty_tpl->tpl_vars['image_name']->value) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['image_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>" id="file_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_var_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
