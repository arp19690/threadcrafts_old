<?php /* Smarty version Smarty-3.1.18, created on 2015-09-09 10:28:58
         compiled from "/var/www/html/design/backend/templates/addons/rma/views/rma/details.tpl" */ ?>
<?php /*%%SmartyHeaderCode:194479278455efbc92abf723-68813153%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7febf65020f6bba2216a858567befb1e30eae4c7' => 
    array (
      0 => '/var/www/html/design/backend/templates/addons/rma/views/rma/details.tpl',
      1 => 1439189760,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '194479278455efbc92abf723-68813153',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55efbc92ccf1a7_89573832',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55efbc92ccf1a7_89573832')) {function content_55efbc92ccf1a7_89573832($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/app/functions/smarty_plugins/modifier.date_format.php';
if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
?><?php
fn_preload_lang_vars(array('rma_return','by','on','decline_products','product','price','quantity','reason','free','no_data','accept_products','product','price','quantity','reason','free','no_data','comments','customer_information','status','recalculate_order','manually_recalculate_order','dont_recalculate_order','notify_customer','notify_orders_department','notify_vendor','print_slip','delete_this_return','related_order','return_info'));
?>
...
<input type="hidden" name="change_return_status[order_id]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['return_info']->value['order_id'], ENT_QUOTES, 'UTF-8');?>
" />
<input type="hidden" name="change_return_status[action]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['return_info']->value['action'], ENT_QUOTES, 'UTF-8');?>
" />
<input type="hidden" name="change_return_status[status_from]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['return_info']->value['status'], ENT_QUOTES, 'UTF-8');?>
" />
<input type="hidden" name="change_return_status[return_id]" value="<?php echo htmlspecialchars($_REQUEST['return_id'], ENT_QUOTES, 'UTF-8');?>
" />
...
&nbsp;&nbsp;<span>#<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['return_info']->value['return_id'], ENT_QUOTES, 'UTF-8');?>
</span>&nbsp;
    <?php echo $_smarty_tpl->__("by");?>
&nbsp;&nbsp;<span><?php if ($_smarty_tpl->tpl_vars['return_info']->value['user_id']) {?><a href="<?php echo htmlspecialchars(fn_url("profiles.update?user_id=".((string)$_smarty_tpl->tpl_vars['return_info']->value['user_id'])), ENT_QUOTES, 'UTF-8');?>
"><?php }?><?php echo htmlspecialchars(fn_get_user_name($_smarty_tpl->tpl_vars['return_info']->value['user_id']), ENT_QUOTES, 'UTF-8');?>
<?php if ($_smarty_tpl->tpl_vars['return_info']->value['user_id']) {?></a><?php }?></span>&nbsp;
...
&nbsp;<a href="<?php echo htmlspecialchars(fn_url("rma.returns?period=C&time_from=".((string)$_smarty_tpl->tpl_vars['time_from']->value)."&time_to=".((string)$_smarty_tpl->tpl_vars['time_to']->value)), ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['return_info']->value['timestamp'],((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['date_format'])), ENT_QUOTES, 'UTF-8');?>
</a>,&nbsp;&nbsp;<?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['return_info']->value['timestamp'],((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['time_format'])), ENT_QUOTES, 'UTF-8');?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("tabsbox", null, null); ob_start(); ?>
    ...
    <div id="content_return_products">
        ...
        <div class="clearfix">
            ...
            <?php if ($_smarty_tpl->tpl_vars['return_info']->value['status']==@constant('RMA_DEFAULT_STATUS')) {?>
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_text'=>__("decline_products"),'but_name'=>"dispatch[rma.decline_products]",'but_role'=>"button_main",'but_meta'=>"cm-process-items"), 0);?>
...
?>
        <tr>
            <td width="1%" class="center">
                ...
                <input type="checkbox" name="accepted[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ri']->value['item_id'], ENT_QUOTES, 'UTF-8');?>
            ...
            <td><?php if (!$_smarty_tpl->tpl_vars['ri']->value['deleted_product']) {?><a href="<?php echo htmlspecialchars(fn_url("products.update?product_id=".((string)$_smarty_tpl->tpl_vars['ri']->value['product_id'])), ENT_QUOTES, 'UTF-8');?>
"><?php }?><?php echo (($tmp = @$_smarty_tpl->tpl_vars['ri']->value['product'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['ri']->value['product'] : $tmp);?>
...
<?php }?></td>
            <td>
                <input type="hidden" name="accepted[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ri']->value['item_id'], ENT_QUOTES, 'UTF-8');?>
][previous_amount]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ri']->value['amount'], ENT_QUOTES, 'UTF-8');?>
" />
                ...
                <select name="accepted[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ri']->value['item_id'], ENT_QUOTES, 'UTF-8');?>
...
" <?php if ($_smarty_tpl->getVariable('smarty')->value['section'][$_smarty_tpl->tpl_vars['key']->value]['index']==$_smarty_tpl->tpl_vars['ri']->value['amount']) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->getVariable('smarty')->value['section'][$_smarty_tpl->tpl_vars['key']->value]['index'], ENT_QUOTES, 'UTF-8');?>
</option>
                <?php endfor; endif; ?>
                </select></td>
            <td class="nowrap">
       ...
       <?php if ($_smarty_tpl->tpl_vars['return_info']->value['items'][@constant('RETURN_PRODUCT_DECLINED')]&&$_smarty_tpl->tpl_vars['return_info']->value['status']==@constant('RMA_DEFAULT_STATUS')) {?>
        <div class="clearfix">
            <div class="pull-right">
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_text'=>__("accept_products"),'but_name'=>"dispatch[rma.accept_products]",'but_role'=>"button_main",'but_meta'=>"cm-process-items"), 0);?>
...
?>
        <tr>
            <td width="1%" class="center">
                <input type="checkbox" name="declined[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ri']->value['item_id'], ENT_QUOTES, 'UTF-8');?>
...
<?php }?></td>
            <td>
                <input type="hidden" name="declined[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ri']->value['item_id'], ENT_QUOTES, 'UTF-8');?>
][previous_amount]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ri']->value['amount'], ENT_QUOTES, 'UTF-8');?>
" />
                <select name="declined[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ri']->value['item_id'], ENT_QUOTES, 'UTF-8');?>
][amount]" <?php if ($_smarty_tpl->tpl_vars['return_info']->value['status']!=@constant('RMA_DEFAULT_STATUS')) {?>disabled="disabled"<?php }?> class="input-mini">
                <?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section'][$_smarty_tpl->tpl_vars['key']->value])) unset($_smarty_tpl->tpl_vars['smarty']->value['section'][$_smarty_tpl->tpl_vars['key']->value]);
$_smarty_tpl->tpl_vars['smarty']->value['section'][$_smarty_tpl->tpl_vars['key']->value]['name'] = $_smarty_tpl->tpl_vars['key']->value;
$_smarty_tpl->tpl_vars['smarty']->value['section'][$_smarty_tpl->tpl_vars['key']->value]['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['ri']->value['amount']+1) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
...
<fieldset>
    ...
    <label class="control-label"><?php echo $_smarty_tpl->__("comments");?>
        ...
        <div class="controls">
            <textarea name="comment" cols="55" rows="8" class="input-large"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['return_info']->value['comment'], ENT_QUOTES, 'UTF-8');?>
</textarea>
        </div>
    </div>
</fieldset>
...
<div class="buttons-container">
    <div class="controls">
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_text'=>__("customer_information"),'but_onclick'=>"Tygh."."$"."('#customer_info').toggle();",'but_role'=>"text",'but_meta'=>"text-button"), 0);?>
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"rma:tabs_content"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>
    ...
    <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
        <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("print_slip"),'href'=>"rma.print_slip?return_id=".((string)$_smarty_tpl->tpl_vars['return_info']->value['return_id']),'class'=>"cm-new-window"));?>
</li>
        <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("delete_this_return"),'class'=>"cm-confirm",'href'=>"rma.delete?return_id=".((string)$_smarty_tpl->tpl_vars['return_info']->value['return_id'])));?>
</li>
    <?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_text'=>__("related_order"),'but_href'=>"orders.details?order_id=".((string)$_smarty_tpl->tpl_vars['return_info']->value['order_id']),'but_role'=>"tool"), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>__("return_info"),'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'sidebar'=>Smarty::$_smarty_vars['capture']['sidebar']), 0);?>
