<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 12:20:13
         compiled from "/var/www/html/design/backend/templates/common/object_group.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17886280755a9f725cac149-50736412%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '26c283e9a5bf520b1ffaf60f4cfb89335c6789aa' => 
    array (
  ...
  'nocache_hash' => '17886280755a9f725cac149-50736412',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9f725d870e3_26438105',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9f725d870e3_26438105')) {function content_55a9f725d870e3_26438105($_smarty_tpl) {?><?php
...
"<?php }?> class="row-status cm-external-click<?php if ($_smarty_tpl->tpl_vars['non_editable']->value) {?> no-underline<?php }?><?php if ($_smarty_tpl->tpl_vars['main_link']->value) {?> link<?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link_meta']->value, ENT_QUOTES, 'ISO-8859-1');?>
<?php if ($_smarty_tpl->tpl_vars['is_promo']->value) {?>cm-promo-popup<?php }?>"<?php if (!$_smarty_tpl->tpl_vars['non_editable']->value&&!$_smarty_tpl->tpl_vars['not_clickable']->value) {?> data-ca-external-click-id="opener_group<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?><?php if ($_smarty_tpl->tpl_vars['main_link']->value) {?> <?php if (!$_smarty_tpl->tpl_vars['is_promo']->value) {?>href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['main_link']->value), ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>"<?php }?>><?php if ($_smarty_tpl->tpl_vars['show_id']->value) {?>#<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
