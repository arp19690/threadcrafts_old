<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 15:34:11
         compiled from "/var/www/html/design/themes/responsive/templates/common/tabsbox.tpl" */ ?>
<?php /*%%SmartyHeaderCode:109705930555aa249b830395-29753210%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cfb9b7a1a9e22ca3f83231c53d479dcbfcf5674f' => 
    array (
  ...
  'nocache_hash' => '109705930555aa249b830395-29753210',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa249b921310_92645745',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa249b921310_92645745')) {function content_55aa249b921310_92645745($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_empty_tabs')) include '/var/www/html/app/functions/smarty_plugins/modifier.empty_tabs.php';
...
" class="ty-tabs__item<?php if ($_smarty_tpl->tpl_vars['tab']->value['js']) {?> cm-js<?php } elseif ($_smarty_tpl->tpl_vars['tab']->value['ajax']) {?> cm-js cm-ajax<?php }?><?php if ($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['active_tab']->value) {?> active<?php }?>"><a class="ty-tabs__a" <?php if ($_smarty_tpl->tpl_vars['tab']->value['href']) {?> href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['tab']->value['href']), ENT_QUOTES, 'ISO-8859-1');?>
