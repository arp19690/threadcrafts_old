<?php /* Smarty version Smarty-3.1.18, created on 2015-07-19 01:06:42
         compiled from "/var/www/html/design/themes/responsive/templates/views/companies/apply_for_vendor.tpl" */ ?>
<?php /*%%SmartyHeaderCode:73664123855aaaaca5d0bb0-71184578%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1b6ba61f5b9a5a741f3d82c65145f96ba591f393' => 
    array (
  ...
  'nocache_hash' => '73664123855aaaaca5d0bb0-71184578',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aaaaca7d8563_28528379',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aaaaca7d8563_28528379')) {function content_55aaaaca7d8563_28528379($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/html/app/functions/smarty_plugins/function.set_id.php';
?><?php
            ...
            <?php if (!$_smarty_tpl->tpl_vars['auth']->value['user_id']&&$_smarty_tpl->tpl_vars['settings']->value['Vendors']['create_vendor_administrator_account']=="Y") {?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['use_email_as_login']!='Y') {?>
                    ...
                    <div class="ty-control-group" id="company_description_admin">
                        <label for="company_request_account_name" class="ty-control-group__title cm-trim"><?php echo $_smarty_tpl->__("account_name");?>
</label>
...
" class="ty-input-text" onkeyup="fn_toggle_required_fields();"/>
                    </div>
                <?php } else { ?>
...
" class="ty-input-text<?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['use_email_as_login']!='Y') {?> disabled" disabled="disabled"<?php } else { ?>"<?php }?> />
                </div>
...
" class="ty-input-text" />
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("common/image_verification.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('option'=>"use_for_apply_for_vendor_account",'align'=>"left"), 0);?>
...
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])) {?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A") {?><span class="cm-template-box template-box" data-ca-te-template="views/companies/apply_for_vendor.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/companies/apply_for_vendor.tpl"),$_smarty_tpl);?>
