<?php /* Smarty version Smarty-3.1.18, created on 2015-08-07 15:07:53
         compiled from "/var/www/html/design/backend/templates/addons/news_and_emails/views/mailing_lists/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:206299017255c47c71ce6873-64073023%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b9eafd597f067429931a52a8974c59159c634a76' => 
    array (
      0 => '/var/www/html/design/backend/templates/addons/news_and_emails/views/mailing_lists/update.tpl',
      1 => 1437201145,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '206299017255c47c71ce6873-64073023',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55c47c71d97779_54221154',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55c47c71d97779_54221154')) {function content_55c47c71d97779_54221154($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/app/functions/smarty_plugins/function.script.php';
?><?php
fn_preload_lang_vars(array('general','name','from_name','tt_addons_news_and_emails_views_mailing_lists_update_from_name','from_email','tt_addons_news_and_emails_views_mailing_lists_update_from_email','reply_to','tt_addons_news_and_emails_views_mailing_lists_update_reply_to','register_autoresponder','no_autoresponder','show_on_checkout','show_on_registration','subscribers','add_subscribers'));
?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>__("tt_addons_news_and_emails_views_mailing_lists_update_from_name")), 0);?>
</label>
            <div class="controls">
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>__("tt_addons_news_and_emails_views_mailing_lists_update_from_email")), 0);?>
</label>
            <div class="controls">
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>__("tt_addons_news_and_emails_views_mailing_lists_update_reply_to")), 0);?>
</label>
            <div class="controls">
...
" value="1" <?php if ($_smarty_tpl->tpl_vars['mailing_list']->value['show_on_registration']) {?>checked="checked"<?php }?> />
        ...
        <?php if ($_smarty_tpl->tpl_vars['id']->value) {?>
            <div class="control-group">
                ...
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_text'=>__("add_subscribers"),'but_href'=>"subscribers.manage?list_id=".((string)$_smarty_tpl->tpl_vars['id']->value),'but_role'=>"text"), 0);?>
