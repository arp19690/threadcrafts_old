...
<?php /*%%SmartyHeaderCode:186208027155a9f393cdb367-67617301%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '186208027155a9f393cdb367-67617301',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9f393defe36_96061591',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9f393defe36_96061591')) {function content_55a9f393defe36_96061591($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
...
<!-- Actions -->
<div class="actions cm-sticky-scroll" data-ce-top="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sticky_scroll']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" id="actions_panel">
    ...
    <div class="title pull-left">
        <h2 title="<?php echo htmlspecialchars(preg_replace('!\s+!', ' ',preg_replace('!<[^>]*?>!', ' ', (($tmp = @$_smarty_tpl->tpl_vars['title_alt']->value)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['title']->value : $tmp))), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['title']->value)===null||$tmp==='' ? "&nbsp;" : $tmp);?>
</h2>
    </div>
    <div class="<?php if (isset($_smarty_tpl->tpl_vars['main_buttons_meta']->value)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['main_buttons_meta']->value, ENT_QUOTES, 'ISO-8859-1');?>
<?php } else { ?>btn-bar btn-toolbar<?php }?> dropleft pull-right" <?php if ($_smarty_tpl->tpl_vars['content_id']->value) {?>id="tools_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['content_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_buttons"<?php }?>>
...
<?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['title']->value, ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>
            <?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
