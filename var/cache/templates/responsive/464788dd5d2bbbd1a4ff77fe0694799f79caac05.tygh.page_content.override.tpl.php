<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 19:24:48
         compiled from "/var/www/html/design/themes/responsive/templates/addons/form_builder/hooks/pages/page_content.override.tpl" */ ?>
<?php /*%%SmartyHeaderCode:151193538355aa5aa8a8eec4-18020215%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '464788dd5d2bbbd1a4ff77fe0694799f79caac05' => 
    array (
  ...
  'nocache_hash' => '151193538355aa5aa8a8eec4-18020215',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa5aa8db1fd7_55505289',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa5aa8db1fd7_55505289')) {function content_55aa5aa8db1fd7_55505289($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
...
<?php } else { ?>elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>" class="ty-control-group__title <?php if ($_smarty_tpl->tpl_vars['element']->value['required']=="Y") {?>cm-required<?php }?><?php if ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_EMAIL')) {?> cm-email<?php }?><?php if ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_PHONE')) {?> cm-phone<?php }?> <?php if ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_MULTIPLE_CB')) {?>cm-multiple-checkboxes<?php }?>"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</label>
...
?>
                    <label class="ty-form-builder__checkbox-label">
                        <input class="ty-form-builder__checkbox" type="checkbox" <?php if ($_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value]==$_smarty_tpl->tpl_vars['var']->value['element_id']) {?>checked="checked"<?php }?> id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
...
" />
            ...
            <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_INPUT')) {?>
                <input id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="ty-form-builder__input-text ty-input-text" size="50" type="text" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
...
" />
                <?php }?>
                <input id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="ty-input-text" size="50" type="text" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value], ENT_QUOTES, 'ISO-8859-1');?>
" />
...
" <?php if ($_smarty_tpl->tpl_vars['_country']->value==$_smarty_tpl->tpl_vars['code']->value) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['country']->value, ENT_QUOTES, 'ISO-8859-1');?>
            ...
            <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_STATES')) {?>
                ...
                <select class="ty-form-builder__state cm-state cm-location-billing" id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
]">
                    <option label="" value="">- <?php echo $_smarty_tpl->__("select_state");?>
 -</option>
                </select>
                <input type="text" class="cm-state cm-location-billing ty-input-text hidden" id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
