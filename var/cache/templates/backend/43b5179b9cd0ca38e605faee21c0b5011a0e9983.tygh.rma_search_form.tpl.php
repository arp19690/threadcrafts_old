<?php /* Smarty version Smarty-3.1.18, created on 2015-09-09 10:19:45
         compiled from "/var/www/html/design/backend/templates/addons/rma/views/rma/components/rma_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:34276554655efba6985eab1-78534618%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '43b5179b9cd0ca38e605faee21c0b5011a0e9983' => 
    array (
      0 => '/var/www/html/design/backend/templates/addons/rma/views/rma/components/rma_search_form.tpl',
      1 => 1439189760,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '34276554655efba6985eab1-78534618',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55efba698e5286_96719026',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55efba698e5286_96719026')) {function content_55efba698e5286_96719026($_smarty_tpl) {?><?php
...
:</label>
            <input type="text" name="rma_amount_from" id="rma_amount_from" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['rma_amount_from'], ENT_QUOTES, 'UTF-8');?>
" size="3" class="input-small" />&nbsp;&ndash;&nbsp;<input type="text" name="rma_amount_to" class="input-small" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['rma_amount_to'], ENT_QUOTES, 'UTF-8');?>
" size="3" />
        </div>
...
:</label>
            <div class="controls">
                <input type="text" name="return_id" id="return_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['return_id'], ENT_QUOTES, 'UTF-8');?>
" size="30" />
            </div>
        </div>
...
" <?php if ($_smarty_tpl->tpl_vars['search']->value['action']==$_smarty_tpl->tpl_vars['action_id']->value) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['action']->value['property'], ENT_QUOTES, 'UTF-8');?>
</option>
                        <?php } ?>
                    </select>
                </div>
