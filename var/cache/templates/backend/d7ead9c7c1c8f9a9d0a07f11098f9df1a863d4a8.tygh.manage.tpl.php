<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 15:08:33
         compiled from "/var/www/html/design/backend/templates/addons/news_and_emails/views/news/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1866108755aa1e99991226-39061719%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd7ead9c7c1c8f9a9d0a07f11098f9df1a863d4a8' => 
    array (
      0 => '/var/www/html/design/backend/templates/addons/news_and_emails/views/news/manage.tpl',
      1 => 1437201145,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1866108755aa1e99991226-39061719',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa1e99a59ad3_95820630',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa1e99a59ad3_95820630')) {function content_55aa1e99a59ad3_95820630($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/app/functions/smarty_plugins/modifier.date_format.php';
?><?php
...
?>
<tbody>
<tr class="cm-row-status-<?php echo htmlspecialchars(strtolower($_smarty_tpl->tpl_vars['n']->value['status']), ENT_QUOTES, 'ISO-8859-1');?>
" valign="top" >
    ...
    <?php }?>
    <td class="left <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['no_hide_input']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
        <input type="checkbox" name="news_ids[]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['n']->value['news_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-item" /></td>
    <td class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['no_hide_input']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
        <a class="row-status" href="<?php echo htmlspecialchars(fn_url("news.update?news_id=".((string)$_smarty_tpl->tpl_vars['n']->value['news_id'])), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['n']->value['news'], ENT_QUOTES, 'ISO-8859-1');?>
    ...
    <td class="left nowrap <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['no_hide_input']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
        <span><?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['n']->value['date'],((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['date_format'])), ENT_QUOTES, 'ISO-8859-1');?>
</span>
    </td>
