...
<div class="center-block flip-container{if $addons.fliping_product_icons.show_effect == 'vertical_flip'} vertical{/if}">
	<div class="thumbs-wrapper cm-image-gallery flipper">
