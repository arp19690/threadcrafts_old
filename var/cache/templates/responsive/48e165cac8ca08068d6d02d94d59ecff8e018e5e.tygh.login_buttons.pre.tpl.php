<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 09:34:37
         compiled from "/var/www/html/design/themes/responsive/templates/addons/hybrid_auth/hooks/index/login_buttons.pre.tpl" */ ?>
<?php /*%%SmartyHeaderCode:185370955a9f37de5a7d9-57367653%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '48e165cac8ca08068d6d02d94d59ecff8e018e5e' => 
    array (
      0 => '/var/www/html/design/themes/responsive/templates/addons/hybrid_auth/hooks/index/login_buttons.pre.tpl',
      1 => 1437201220,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '185370955a9f37de5a7d9-57367653',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9f37dec18e6_13214381',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9f37dec18e6_13214381')) {function content_55a9f37dec18e6_13214381($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/html/app/functions/smarty_plugins/function.set_id.php';
?><?php
...
?><?php if ($_smarty_tpl->tpl_vars['provider_data']->value['status']=='A') {?><input type="hidden" name="redirect_url" id="redirect_url" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['redirect_url']->value, ENT_QUOTES, 'ISO-8859-1');?>
" /><a class="cm-login-provider ty-hybrid-auth-icon" data-idp="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['provider_data']->value['provider'], ENT_QUOTES, 'ISO-8859-1');?>
"><img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['images_dir']->value, ENT_QUOTES, 'ISO-8859-1');?>
/addons/hybrid_auth/icons/<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['addons']->value['hybrid_auth']['icons_pack'], ENT_QUOTES, 'ISO-8859-1');?>
/<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['provider_data']->value['provider'], ENT_QUOTES, 'ISO-8859-1');?>
.png" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['provider_data']->value['provider'], ENT_QUOTES, 'ISO-8859-1');?>
" /></a><?php }?><?php } ?>
    </p>
