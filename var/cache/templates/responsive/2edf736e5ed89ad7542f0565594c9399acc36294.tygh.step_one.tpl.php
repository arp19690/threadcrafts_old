<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 20:43:49
         compiled from "/var/www/html/design/themes/responsive/templates/views/checkout/components/steps/step_one.tpl" */ ?>
<?php /*%%SmartyHeaderCode:191734116655aa6d2d3f6897-68403696%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2edf736e5ed89ad7542f0565594c9399acc36294' => 
    array (
      0 => '/var/www/html/design/themes/responsive/templates/views/checkout/components/steps/step_one.tpl',
      1 => 1437201213,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '191734116655aa6d2d3f6897-68403696',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa6d2d5e58b6_99289647',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa6d2d5e58b6_99289647')) {function content_55aa6d2d5e58b6_99289647($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["title"] = new Smarty_variable($_tmp1." ".((string)$_smarty_tpl->tpl_vars['login_info']->value), null, 0);?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['contact_info_population']->value&&!$_smarty_tpl->tpl_vars['edit']->value) {?>
                <a class="ty-step__title-txt cm-ajax" href="<?php echo htmlspecialchars(fn_url("checkout.checkout?edit_step=step_one&from_step=".((string)$_smarty_tpl->tpl_vars['edit_step']->value)), ENT_QUOTES, 'ISO-8859-1');?>
    ...
    <div id="step_one_body" class="ty-step__body<?php if ($_smarty_tpl->tpl_vars['edit']->value) {?>-active<?php }?><?php if (!$_smarty_tpl->tpl_vars['edit']->value) {?> hidden<?php }?>">
        <?php if (($_smarty_tpl->tpl_vars['settings']->value['General']['disable_anonymous_checkout']=="Y"&&!$_smarty_tpl->tpl_vars['auth']->value['user_id'])||($_smarty_tpl->tpl_vars['settings']->value['General']['disable_anonymous_checkout']!="Y"&&!$_smarty_tpl->tpl_vars['auth']->value['user_id']&&!$_smarty_tpl->tpl_vars['contact_info_population']->value)||$_SESSION['failed_registration']==true) {?>
            ...
            <div id="step_one_register" class="clearfix<?php if ($_REQUEST['login_type']!="register") {?> hidden<?php }?>">
                    <form name="step_one_register_form" class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ajax_form']->value, ENT_QUOTES, 'ISO-8859-1');?>
 cm-ajax-full-render" action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
" method="post">
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"checkout:checkout_steps"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
        ...
        <?php } else { ?>
            <form name="step_one_contact_information_form" class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ajax_form']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" method="<?php if (!$_smarty_tpl->tpl_vars['edit']->value) {?>get<?php } else { ?>post<?php }?>">
            ...
            <input type="hidden" name="next_step" value="<?php if ($_REQUEST['from_step']&&$_REQUEST['from_step']!="step_one") {?><?php echo htmlspecialchars($_REQUEST['from_step'], ENT_QUOTES, 'ISO-8859-1');?>
            ...
            <input type="hidden" name="result_ids" value="checkout*" />
                ...
                <div class="clearfix">
                    <div class="checkout__block">
                        ...
                        <a href="<?php echo htmlspecialchars(fn_url("auth.change_login"), ENT_QUOTES, 'ISO-8859-1');?>
