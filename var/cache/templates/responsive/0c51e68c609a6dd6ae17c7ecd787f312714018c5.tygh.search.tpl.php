<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 09:34:38
         compiled from "/var/www/html/design/themes/responsive/templates/common/search.tpl" */ ?>
<?php /*%%SmartyHeaderCode:177411498655a9f37e3bbc78-60310235%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0c51e68c609a6dd6ae17c7ecd787f312714018c5' => 
    array (
  ...
  'nocache_hash' => '177411498655a9f37e3bbc78-60310235',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9f37e442ee9_68355332',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9f37e442ee9_68355332')) {function content_55a9f37e442ee9_68355332($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"search:additional_fields"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['search_objects']) {?><?php $_smarty_tpl->tpl_vars["search_title"] = new Smarty_variable($_smarty_tpl->__("search"), null, 0);?><?php } else { ?><?php $_smarty_tpl->tpl_vars["search_title"] = new Smarty_variable($_smarty_tpl->__("search_products"), null, 0);?><?php }?><input type="text" name="q" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['q'], ENT_QUOTES, 'ISO-8859-1');?>
" id="search_input<?php if (Smarty::$_smarty_vars['capture']['search_input_id']) {?>_<?php echo htmlspecialchars(Smarty::$_smarty_vars['capture']['search_input_id'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search_title']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
<?php }?>
        ...
        <?php $_smarty_tpl->_capture_stack[0][] = array("search_input_id", null, null); ob_start(); ?>
            ...
            <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search_input_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
