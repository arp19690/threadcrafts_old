<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 09:34:37
         compiled from "/var/www/html/design/themes/responsive/templates/blocks/languages.tpl" */ ?>
<?php /*%%SmartyHeaderCode:33744916755a9f37d731498-99797426%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '37b397ef7a0ecdea3c57c0647358fbc05a1a1cee' => 
    array (
  ...
  'nocache_hash' => '33744916755a9f37d731498-99797426',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9f37d7e3b00_11971863',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9f37d7e3b00_11971863')) {function content_55a9f37d7e3b00_11971863($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/html/app/functions/smarty_plugins/function.set_id.php';
?><?php
fn_preload_lang_vars(array('change_language','change_language'));
?>
<?php if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['design']=="Y"&&@constant('AREA')=="C") {?><?php $_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start(); ?><div id="languages_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['block_id'], ENT_QUOTES, 'ISO-8859-1');?>
">
...
" class="ty-languages__item<?php if ($_smarty_tpl->tpl_vars['format']->value=="icon") {?> ty-languages__icon-link<?php }?><?php if (@constant('DESCR_SL')==$_smarty_tpl->tpl_vars['code']->value) {?> ty-languages__active<?php }?>"><i class="ty-flag ty-flag-<?php echo htmlspecialchars(strtolower($_smarty_tpl->tpl_vars['language']->value['country_code']), ENT_QUOTES, 'ISO-8859-1');?>
"></i><?php if ($_smarty_tpl->tpl_vars['format']->value=="name") {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
<?php }?></a>
            <?php } ?>
        </div>
    <?php } else { ?>
...
<?php }?><?php }?><?php } else { ?><div id="languages_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['block_id'], ENT_QUOTES, 'ISO-8859-1');?>
">
    <?php if ($_smarty_tpl->tpl_vars['languages']->value&&count($_smarty_tpl->tpl_vars['languages']->value)>1) {?>
    <?php if ($_smarty_tpl->tpl_vars['dropdown_limit']->value>0&&count($_smarty_tpl->tpl_vars['languages']->value)<=$_smarty_tpl->tpl_vars['dropdown_limit']->value) {?>
        <div class="ty-select-wrapper ty-languages">
