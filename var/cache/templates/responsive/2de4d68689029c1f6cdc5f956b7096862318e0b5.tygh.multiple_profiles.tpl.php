<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 20:48:14
         compiled from "/var/www/html/design/themes/responsive/templates/views/profiles/components/multiple_profiles.tpl" */ ?>
<?php /*%%SmartyHeaderCode:139669221955aa6e36d66267-70787075%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2de4d68689029c1f6cdc5f956b7096862318e0b5' => 
    array (
      0 => '/var/www/html/design/themes/responsive/templates/views/profiles/components/multiple_profiles.tpl',
      1 => 1437201213,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '139669221955aa6e36d66267-70787075',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa6e36eb5872_40451511',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa6e36eb5872_40451511')) {function content_55aa6e36eb5872_40451511($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/html/app/functions/smarty_plugins/function.set_id.php';
?><?php
...
?>
        ...
        <strong><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['up']->value['profile_name'], ENT_QUOTES, 'ISO-8859-1');?>
</strong>
        <?php } else { ?>
        <a <?php if ($_smarty_tpl->tpl_vars['use_ajax']->value) {?>class="cm-ajax"<?php }?> href="<?php echo htmlspecialchars(fn_url(fn_link_attach(fn_query_remove($_smarty_tpl->tpl_vars['config']->value['current_url'],"profile","selected_section"),"profile_id=".((string)$_smarty_tpl->tpl_vars['up']->value['profile_id']))), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id="checkout_steps,cart_items,checkout_totals"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['up']->value['profile_name'], ENT_QUOTES, 'ISO-8859-1');?>
</a>
        <?php }?>
...
</strong><?php } else { ?><a class="<?php if ($_smarty_tpl->tpl_vars['use_ajax']->value) {?> cm-ajax<?php }?>" href="<?php if ($_smarty_tpl->tpl_vars['create_href']->value) {?><?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['create_href']->value), ENT_QUOTES, 'ISO-8859-1');?>
<?php } else { ?><?php echo htmlspecialchars(fn_url(fn_link_attach(fn_query_remove($_smarty_tpl->tpl_vars['config']->value['current_url'],"profile_id","selected_section"),"profile=new")), ENT_QUOTES, 'ISO-8859-1');?>
...
:</label>
    ...
    <input type="hidden" name="user_data[profile_id]" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['profile_id']->value)===null||$tmp==='' ? "0" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
" />
    <input type="text" class="ty-input-text" id="elm_profile_id" name="user_data[profile_name]" size="32" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['user_data']->value['profile_name'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['profile_name']->value : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
" />
</div>
<?php }?>

<?php } else { ?>
    <input type="hidden" id="profile_name" name="user_data[profile_name]" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['user_data']->value['profile_name'])===null||$tmp==='' ? $_smarty_tpl->__("main") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
" />
