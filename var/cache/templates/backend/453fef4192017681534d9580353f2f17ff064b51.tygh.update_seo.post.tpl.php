...
<?php /*%%SmartyHeaderCode:84113930955a9fab09aad86-31882790%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '84113930955a9fab09aad86-31882790',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9fab09e4e60_63192903',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9fab09e4e60_63192903')) {function content_55a9fab09e4e60_63192903($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/html/app/functions/smarty_plugins/modifier.truncate.php';
...
<div class="seo-rich-snippet">
    ...
    <h3>
        <a class="srs-title cm-seo-srs-title" href="<?php echo htmlspecialchars(fn_url("products.view?product_id=".((string)$_smarty_tpl->tpl_vars['product_data']->value['product_id']),"C"), ENT_QUOTES, 'ISO-8859-1');?>
" target="_blank"><?php echo htmlspecialchars(smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['product_data']->value['product']),60,"..."), ENT_QUOTES, 'ISO-8859-1');?>
    ...
    <div>
        <div>
            <cite class="srs-url"><?php echo htmlspecialchars(fn_url('',"C"), ENT_QUOTES, 'ISO-8859-1');?>
</cite>
        </div>
