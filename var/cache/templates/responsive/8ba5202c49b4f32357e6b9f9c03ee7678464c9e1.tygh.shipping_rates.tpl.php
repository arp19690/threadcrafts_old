<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 20:48:40
         compiled from "/var/www/html/design/themes/responsive/templates/views/checkout/components/shipping_rates.tpl" */ ?>
<?php /*%%SmartyHeaderCode:102162216455aa6e50af04f1-08089131%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '102162216455aa6e50af04f1-08089131',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa6e50dae1c0_95683286',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa6e50dae1c0_95683286')) {function content_55aa6e50dae1c0_95683286($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
...
<?php if (!$_smarty_tpl->tpl_vars['no_form']->value) {?>
    <form <?php if ($_smarty_tpl->tpl_vars['use_ajax']->value) {?>class="cm-ajax"<?php }?> action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
...
?>
            ...
            <?php if (!fn_allowed_for("ULTIMATE")||count($_smarty_tpl->tpl_vars['product_groups']->value)>1) {?>
                <span class="ty-shipping-options__vendor-name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</span>
            <?php }?>
...
?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['group']->value['shippings']&&!$_smarty_tpl->tpl_vars['group']->value['all_edp_free_shipping']&&!$_smarty_tpl->tpl_vars['group']->value['all_free_shipping']&&!$_smarty_tpl->tpl_vars['group']->value['free_shipping']&&!$_smarty_tpl->tpl_vars['group']->value['shipping_no_required']) {?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['display']->value=="select") {?>
                    <p>
                        <select id="ssr_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" name="shipping_ids[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" <?php if ($_smarty_tpl->tpl_vars['onchange']->value) {?>onchange="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['onchange']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>>
                <?php }?>
                    ...
                    <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"checkout:shipping_method")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"checkout:shipping_method"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['display']->value=="radio") {?>
                            <p class="ty-shipping-options__method">
                                <input type="radio" class="ty-valign" id="sh_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" onclick="fn_calculate_total_shipping_cost();" <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['checked']->value, ENT_QUOTES, 'ISO-8859-1');?>
 />
                                <label for="sh_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_key']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['shipping_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="ty-valign"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['shipping'], ENT_QUOTES, 'ISO-8859-1');?>
...
" <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['selected']->value, ENT_QUOTES, 'ISO-8859-1');?>
><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['shipping'], ENT_QUOTES, 'ISO-8859-1');?>
 ...
 - <?php echo $_smarty_tpl->tpl_vars['rate']->value;?>
                        ...
                        <?php } elseif ($_smarty_tpl->tpl_vars['display']->value=="show") {?>
                            <p>
                                <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['strong_begin']->value, ENT_QUOTES, 'ISO-8859-1');?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rate']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['delivery_time']->value, ENT_QUOTES, 'ISO-8859-1');?>
 - <?php echo $_smarty_tpl->tpl_vars['rate']->value;?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['strong_begin']->value, ENT_QUOTES, 'ISO-8859-1');?>
