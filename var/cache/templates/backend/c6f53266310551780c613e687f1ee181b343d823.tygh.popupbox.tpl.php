...
<?php /*%%SmartyHeaderCode:158460056355a9f394387ba7-65336008%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '158460056355a9f394387ba7-65336008',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9f39449add0_73818377',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9f39449add0_73818377')) {function content_55a9f39449add0_73818377($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/app/lib/other/smarty/plugins/modifier.replace.php';
?><?php
...
"<?php }?> class="hand <?php if (!$_smarty_tpl->tpl_vars['no_icon_link']->value) {?><?php if ($_smarty_tpl->tpl_vars['update_controller']->value=="addons") {?>exicon-cog<?php }?><?php if ($_smarty_tpl->tpl_vars['icon']->value) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['icon']->value, ENT_QUOTES, 'ISO-8859-1');?>
<?php }?><?php }?> <?php if (!$_smarty_tpl->tpl_vars['is_promo']->value) {?>cm-dialog-opener<?php }?><?php if ($_smarty_tpl->tpl_vars['is_promo']->value) {?>cm-promo-popup<?php }?> <?php if ($_smarty_tpl->tpl_vars['_href']->value&&!$_smarty_tpl->tpl_vars['is_promo']->value) {?> <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['opener_ajax_class']->value)===null||$tmp==='' ? 'cm-ajax' : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
<?php }?><?php if ($_smarty_tpl->tpl_vars['link_class']->value) {?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>" <?php if ($_smarty_tpl->tpl_vars['_href']->value&&!$_smarty_tpl->tpl_vars['is_promo']->value) {?> href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_href']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
<?php }?><?php if ($_smarty_tpl->tpl_vars['link_class']->value) {?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>" <?php if ($_smarty_tpl->tpl_vars['_href']->value) {?> href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_href']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?> <?php echo $_smarty_tpl->tpl_vars['popup_params']->value;?>
 title="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['link_text']->value)===null||$tmp==='' ? $_smarty_tpl->__("edit") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
