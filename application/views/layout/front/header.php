...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    ...
    <body class="">
        ...
        <div class="please-wait-currency">
            <h1>Please wait...</h1>
            <h3>while we do the calculation with currency exchange prices for you</h3>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="span8">
                                <div class="topmost-line">
                                    ...
                                    <?php
                                        $user_currency = "";
                                        if (!$this->input->cookie("user_currency"))
                                        {
                                            $user_currency = DEFAULT_CURRENCY;
                                        }
                                        else
                                        {
                                            $user_currency = $this->input->cookie("user_currency");
                                        }
                                    ?>
                                                                                    <span class="js-change-text"><?php echo $user_currency . " (" . getCurrencySymbol("$user_currency") . ")"; ?></span> <b class="caret"></b>
                                                                                </a>
                                                                                <ul class="dropdown-menu js-possibilities currency-change-ul" role="menu" aria-labelledby="dLabel" id="<?php echo getCurrencySymbol(getCurrentCurrency()); ?>">
                                    <?php
                                        $redirectUrl = urlencode(current_url());
                                    ?>
                                                                                    <li><a href="<?php echo base_url("config/changeCurrency/INR?url=" . $redirectUrl); ?>">INR (<?php echo getCurrencySymbol("INR"); ?>)</a></li>
                                                                                    <li><a href="<?php echo base_url("config/changeCurrency/USD?url=" . $redirectUrl); ?>">USD (<?php echo getCurrencySymbol("USD"); ?>)</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>-->
                                </div>
