<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 22:33:34
         compiled from "/var/www/html/design/backend/templates/views/file_editor/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:159691287555aa86e6db42b4-25702561%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1e85bb3a180c07d1a09b5abc5c27b16dc403583e' => 
    array (
      0 => '/var/www/html/design/backend/templates/views/file_editor/manage.tpl',
      1 => 1437201145,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '159691287555aa86e6db42b4-25702561',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa86e6ee90e9_39438411',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa86e6ee90e9_39438411')) {function content_55aa86e6ee90e9_39438411($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/app/functions/smarty_plugins/function.script.php';
...
'
        ...
        _.file_editor.selected_path = '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['selected_path']->value, ENT_QUOTES, 'ISO-8859-1');?>
';
        <?php }?>
        _.file_editor.rel_path = '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rel_path']->value, ENT_QUOTES, 'ISO-8859-1');?>
';
    }(Tygh, Tygh.$));
</script>
...
?>
            <li <?php if ($_smarty_tpl->tpl_vars['active_section']->value==$_smarty_tpl->tpl_vars['section']->value) {?>class="active"<?php }?>><a href="<?php echo htmlspecialchars(fn_url("file_editor.manage?active_section=".((string)$_smarty_tpl->tpl_vars['section']->value)."&selected_path=/"), ENT_QUOTES, 'ISO-8859-1');?>
