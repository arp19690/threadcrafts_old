<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 20:55:02
         compiled from "/var/www/html/design/themes/responsive/templates/views/orders/components/placing_order.tpl" */ ?>
<?php /*%%SmartyHeaderCode:75655556955aa6fce972860-77964789%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '75655556955aa6fce972860-77964789',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa6fce9de2d1_15229568',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa6fce9de2d1_15229568')) {function content_55aa6fce9de2d1_15229568($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/html/app/functions/smarty_plugins/function.set_id.php';
?><?php
...
<head>
<title><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_action']->value, ENT_QUOTES, 'ISO-8859-1');?>
</title>
<?php echo $_smarty_tpl->getSubTemplate ("common/styles.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

</head>

<body class="clear-body" <?php if ($_smarty_tpl->tpl_vars['onload']->value) {?>onload="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['onload']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>>
    <?php if ($_smarty_tpl->tpl_vars['order_action']->value) {?>
    <div class="ty-order-status">
        <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order_action']->value, ENT_QUOTES, 'ISO-8859-1');?>
. <?php echo $_smarty_tpl->__("please_be_patient");?>
...
    </div>
    <?php }?>

    <div id="place_order_data"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['payment_content']->value, ENT_QUOTES, 'ISO-8859-1');?>
</div>
</body>
</html>
