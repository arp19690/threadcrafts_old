<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 20:36:40
         compiled from "/var/www/html/design/backend/templates/pickers/orders/picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:107242756255aa6b80ca1572-72976805%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ff91b7783f441d6ef4fcce1a4ff3042cc6e09920' => 
    array (
  ...
  'nocache_hash' => '107242756255aa6b80ca1572-72976805',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa6b80de9dd3_98840166',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa6b80de9dd3_98840166')) {function content_55aa6b80de9dd3_98840166($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/app/lib/other/smarty/plugins/function.math.php';
...
_clear" class="reload-container<?php if (!$_smarty_tpl->tpl_vars['item_ids']->value) {?> hidden<?php }?>">
                    <?php ob_start();?><?php echo htmlspecialchars(fn_url("orders.manage?order_id="), ENT_QUOTES, 'ISO-8859-1');?>
...
?>
    ...
    <span id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_details"<?php if (count($_smarty_tpl->tpl_vars['item_ids']->value)<=$_smarty_tpl->tpl_vars['max_displayed_qty']->value) {?> class="hidden"<?php }?>><a href="<?php echo htmlspecialchars(fn_url("orders.manage?order_id="), ENT_QUOTES, 'ISO-8859-1');?>
<?php if ($_smarty_tpl->tpl_vars['item_ids']->value) {?><?php echo htmlspecialchars(implode(',',$_smarty_tpl->tpl_vars['item_ids']->value), ENT_QUOTES, 'ISO-8859-1');?>
<?php }?>">..</a></span>
    <span id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
?>
        ...
        <?php } ?>
        <tr class="no-items <?php if ($_smarty_tpl->tpl_vars['item_ids']->value) {?>hidden<?php }?>" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
_no_item">
