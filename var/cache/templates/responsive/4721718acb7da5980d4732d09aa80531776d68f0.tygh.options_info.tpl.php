<?php /* Smarty version Smarty-3.1.18, created on 2015-07-18 20:43:50
         compiled from "/var/www/html/design/themes/responsive/templates/common/options_info.tpl" */ ?>
<?php /*%%SmartyHeaderCode:44034103455aa6d2e201542-30250853%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4721718acb7da5980d4732d09aa80531776d68f0' => 
    array (
  ...
  'nocache_hash' => '44034103455aa6d2e201542-30250853',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55aa6d2e389293_85902275',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55aa6d2e389293_85902275')) {function content_55aa6d2e389293_85902275($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/html/app/functions/smarty_plugins/modifier.truncate.php';
...
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['options_content'])&&trim(Smarty::$_smarty_vars['capture']['options_content'])!='&nbsp;') {?><span class="ty-product-options clearfix"><span class="ty-product-options-name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['po']->value['option_name'], ENT_QUOTES, 'ISO-8859-1');?>
:&nbsp;</span><span class="ty-product-options-content"><?php echo Smarty::$_smarty_vars['capture']['options_content'];?>
<?php if ($_smarty_tpl->tpl_vars['inline_option']->value) {?>;<?php }?>&nbsp;</span></span><?php }?><?php if ($_smarty_tpl->tpl_vars['fields_prefix']->value) {?><input type="hidden" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields_prefix']->value, ENT_QUOTES, 'ISO-8859-1');?>
