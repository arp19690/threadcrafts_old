...
<?php /*%%SmartyHeaderCode:41858182355a9fab06a6e25-99646475%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '41858182355a9fab06a6e25-99646475',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55a9fab08078a3_55035832',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55a9fab08078a3_55035832')) {function content_55a9fab08078a3_55035832($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/app/lib/other/smarty/plugins/function.math.php';
?><?php
        ...
        <?php if ($_smarty_tpl->tpl_vars['first_item']->value||!$_smarty_tpl->tpl_vars['category_id']->value) {?>
            <p class="cm-js-item cm-clone hidden">
                <?php if ($_smarty_tpl->tpl_vars['hide_input']->value!="Y") {?>
                    <label class="radio inline-block" for="category_rb_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['default_category_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                        <input id="category_rb_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['default_category_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" type="radio" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['radio_input_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
