                                ...
                                <div class="controls">
                                    <span class='copy-this'>
                                        ...
                                        for ($i = 0; $i <= MAX_PRODUCT_IMAGES - 1; $i++)
                                        {
                                            $required_input = '';
                                            $required_text = '';
                                            if ($i <= MIN_PRODUCT_IMAGES && !isset($image_records[$i]['pi_id']) && empty($image_records[$i]['pi_id']))
                                            {
                                            ...
                                            <div class='clearfix'>
                                                ...
                                                <div class='span3'>
                                                    ...
                                                    <div style="width: 50px;height: 50px">
                                                        ...
                                                        <?php
                                                        if (!empty($image_records[$i]['pi_image_path']))
                                                        {
                                                            echo '<a href="' . base_url_admin('products/removeImage/' . $image_records[$i]['pi_id']) . '?url=' . current_url() . '" onclick="return confirm(\'Are you sure to remove this image?\');" style="margin-bottom:20px;color:#ff0000">Remove</a>';
                                                        }
                                                        ?>
                                                    </div>
                                                </div>
